...
var _ref /*__reshadow_css_start__*/ =
    (__css__(
      /*__inner_css_start__*/ '.___SButton_c5m54_gg_{padding:0 20px;background:purple}.___SButton_c5m54_gg_._theme_default_c5m54_gg_{background:red;background:#bada55}',
      'c5m54_gg_',
    ),
    {
