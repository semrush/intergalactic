import type { Colors, Lightness } from './colors/index.ts';
import {
  colors,
  semanticColors,
  baseColors,
...
const { neutral, brand, error, advertising, focus, highlight, info, link, success, warning } =
  semanticColors;
...
export const theme: Theme = {
  ...
  semanticTokens: {
    colors: {
      ...
      text_secondary_DEFAULT: {
        ...
        description:
          'Supporting text: captions, metadata, hints in flowing copy—visually quieter than primary body text.',
      },
      ...
      text_link_visited: {
        ...
        description:
          'Visited link state so users can tell visited destinations apart from default links.',
      },
      text_hint_DEFAULT: {
        value: neutral.opaqueAt(L_TEXT_SECONDARY),
        description:
          'Supplementary helper text near controls (short guidance), distinct from placeholder text inside inputs.',
      },
      ...
      text_advertising: {
        ...
        description:
          'Promotional or sponsored emphasis (ads, marketing callouts)—use sparingly so it stays noticeable.',
      },
      ...
      border_critical_pattern: {
        value:
          'repeating-linear-gradient(315deg, {semanticTokens.colors.border.critical.active} 0, {semanticTokens.colors.border.critical.active} 1px, transparent 0, transparent 50%)',
        description:
      ...
      icon_primary_neutral_DEFAULT: {
        ...
        description:
          'Default icon weight on normal backgrounds—stronger emphasis than secondary icons.',
      },
      ...
      icon_secondary_success_DEFAULT: {
        ...
        description:
          'Softer success icon for dense UI or inline hints where the surface should stay calm.',
      },
      ...
      icon_secondary_critical_DEFAULT: {
        ...
        description:
          'Softer error icon for dense UI or inline hints where the surface should stay calm.',
      },
      ...
      icon_secondary_warning_DEFAULT: {
        ...
        description:
          'Softer warning icon for dense UI or inline hints where the surface should stay calm.',
      },
      ...
      progress_bar_value_gradient: {
        value: `linear-gradient(-45deg, oklch(from ${highlight.at(
          0.74,
        )} calc(l - 0.05) c h) 25%, ${highlight.at(0.74)} 0%, ${highlight.at(
          0.74,
        )} 50%, oklch(from ${highlight.at(0.74)} calc(l - 0.05) c h) 0%, oklch(from ${highlight.at(
          0.74,
        )} calc(l - 0.05) c h) 75%, ${highlight.at(0.74)} 0%)`,
      ...
      progress_bar_pattern_gradient: {
        value:
          'linear-gradient(-45deg, oklch(0 0 0 / 0.1) 25%, {semanticTokens.colors.progress.bar.bg} 0%, {semanticTokens.colors.progress.bar.bg} 50%, oklch(0 0 0 / 0.1) 0%, oklch(0 0 0 / 0.1) 75%, {semanticTokens.colors.progress.bar.bg} 0%)',
      ...
      brand_secondary: {
        value: gray.at(0.22),
        description:
          'Secondary brand accent for paired brand treatments (secondary marks, duo-tone lockups).',
      },
      brand_gradient: {
      ...
      brand_pinterest: {
        value: '#bd081c',
        description:
          'Official Pinterest brand fill for logos and icons in approved placements; follow the platform brand rules for size and clear space.',
      },
      brand_instagram: {
        value: '#e4405f',
        description:
          'Official Instagram brand fill for logos and icons in approved placements; follow the platform brand rules for size and clear space.',
      },
      brand_youtube: {
        value: '#ff0000',
        description:
          'Official YouTube brand fill for logos and icons in approved placements; follow the platform brand rules for size and clear space.',
      },
      brand_facebook: {
        value: '#1877f2',
        description:
          'Official Facebook brand fill for logos and icons in approved placements; follow the platform brand rules for size and clear space.',
      },
      brand_linkedIn: {
        value: '#0a66c2',
        description:
          'Official LinkedIn brand fill for logos and icons in approved placements; follow the platform brand rules for size and clear space.',
      },
      brand_twitter: {
        value: '#1d9bf0',
        description:
          'Official Twitter brand fill for logos and icons in approved placements; follow the platform brand rules for size and clear space.',
      },
      ...
      brand_google_my_business: {
        value: '#1a73e8',
        description:
          'Official Google My Business brand fill for logos and icons in approved placements; follow Google brand guidelines for size and clear space.',
      },
      ...
      tag_primary_white_normal: {
        ...
        description:
          'Primary tag on bold or dark backgrounds—translucent fill for contrast in the normal state.',
      },
      ...
      tag_secondary_white_normal: {
        ...
        description:
          'Secondary/outline tag on bold or dark backgrounds—minimal fill in the normal state.',
      },
    ...
    shadows: {
      box_shadow_card_DEFAULT: {
        value: `0px 0px 1px 0px ${neutral.opaqueAt(
          L_BORDER_SECONDARY,
    ...
    radii: {
      ...
      badge: {
        ...
        description:
          'Corner radius for Badge and compact status chips—aligned with small rounded controls.',
      },
      chart: {
  ...
  featureHighlight: {
    ...
    'bg_primary_feature-highlight_hover_active': {
      value:
        'linear-gradient(90deg in oklch, {baseTokens.colors.violet.50}, {baseTokens.colors.blue.75})',
      description:
    ...
    'border_feature-highlight_DEFAULT': {
      value:
        'linear-gradient(90deg in oklch, {baseTokens.colors.violet.200}, {baseTokens.colors.blue.200})',
      description: 'Primary border for highlighted controls.',
    },
    'border_feature-highlight_active': {
      value:
        'linear-gradient(90deg in oklch, {baseTokens.colors.violet.300}, {baseTokens.colors.blue.300})',
    ...
    'control_primary_feature-highlight_DEFAULT': {
      value:
        'linear-gradient(90deg in oklch, {baseTokens.colors.violet.400}, {baseTokens.colors.blue.300})',
    ...
    'control_primary_feature-highlight_active': {
      value:
        'linear-gradient(90deg in oklch, {baseTokens.colors.violet.400}, {baseTokens.colors.blue.400})',
      description: 'Active (selected) state of the highlighted primary control.',
    },
    'control_secondary_feature-highlight_DEFAULT': {
      value:
        'linear-gradient(90deg in oklch, {baseTokens.colors.violet.50}, {baseTokens.colors.blue.50})',
      description: 'Background of the highlighted secondary control.',
    },
    'control_secondary_feature-highlight_hover': {
      value:
        'linear-gradient(90deg in oklch, {baseTokens.colors.violet.100}, {baseTokens.colors.blue.100})',
    ...
    'text_feature-highlight_DEFAULT': {
      value:
        'linear-gradient(90deg in oklch, {baseTokens.colors.violet.500}, {baseTokens.colors.blue.500})',
    ...
    'keyboard_focus_feature-highlight_outline': {
      value:
        'linear-gradient(90deg in oklch, {baseTokens.colors.violet.300}, {baseTokens.colors.blue.400})',
  ...
  deprecates: {
    ...
    table: {
      td: {
        cell: {
          actions: { accordion: { value: '{semanticTokens.colors.table_td_cell_accordion}' } },
        },
      },
    },
    keyboard: {
...
export type BaseTokens = {
  colors: Record<Colors, Record<Lightness, Value>> &
    Record<'gray', Record<'white', Value>> &
    Record<'white' | 'black' | 'transparent' | 'current', Value>;
  fonts: { base: Value };
