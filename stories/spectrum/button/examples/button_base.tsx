...
import Button from '@semcore/spectrum/button';
import type { NSSpectrumButton } from '@semcore/spectrum/button';
...
type ExampleProps = Exclude<NSSpectrumButton.Props, 'theme' | 'use'> & { style?: any; theme: string };
...
export const defaultButtonProps: ExampleProps = {
  ...
  theme: 'info',
  hintPlacement: 'top',
  style: undefined, // this prop is needed for background to verify some button themes (primary invert for instance)
};
