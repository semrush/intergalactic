...
const Demo = () => {
  return (
    <Flex direction={'row'} gap={6} alignItems={'flex-start'}>
      ...
      <Tooltip tag={Button} addonLeft={SearchM} use={'primary'} title='Tooltip Button secondary Addon' />
      ...
      <Tooltip tag={Button} addonLeft={SearchM} use={'tertiary'} title='Tooltip Button tertiary Addon' />
  </Flex>
  );
};
