  ...
  return (
    <>
      <Flex columnGap={2} mb={4}>
        ...
        <Hint tag={MailFilledM} title='Icon ColoredM Non Interactive' color='text-critical' />

        <Hint tag={MailFilledL} title='Icon ColoredL Non Interactive' color='text-critical' />
      </Flex>
    </>
  );
};
