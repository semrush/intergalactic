...
const Demo = () => {
    return (
        ...
        <Icon width={22} height={22} viewBox='0 0 22 22' color='green' aria-label="icon with size 22">
      ...
      <div style={{ display: 'flex', width: '100px' }}>
        <Icon width={55} height={55} viewBox='0 0 55 55' color='green' aria-label="icon with size 55">
