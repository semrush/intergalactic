...
const getLocators = (page: Page) => ({
  ...
  clearAllBtn: page.locator('[data-ui-name="BulkTextarea.ClearAllButton"]'),
...
test.describe('Manual adding rows', () => {
  ...
  test('Test Validation on Blur', async ({ page }) => {
    ...
    // // //focus order when validation starts
    // // await expect(buttonNext).toBeFocused();
    // // await page.keyboard.press('Tab');
    // // await expect(buttonPrev).toBeFocused();
    // // await page.keyboard.press('Tab');
