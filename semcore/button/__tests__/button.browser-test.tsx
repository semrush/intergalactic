...
test.describe('Button', () => {
  test('Verify uses themes sizes and addons styles', async ({ page }) => {
    ...
    await test.step('Verify secondary muted ', async () => {
      ...
      await expect(lWithAddons.locator('[data-ui-name="Button.Text"]')).toHaveCSS('font-size', '16px');
      await expect(lWithAddons.locator('[data-ui-name="Button.Text"]')).toHaveCSS('margin-left', '8px');
      await expect(lWithAddons.locator('[data-ui-name="Button.Text"]')).toHaveCSS('margin-right', '8px');


      const mWithAddons = flex.locator('[data-ui-name="Button"]').nth(10);
      await expect(mWithAddons).toHaveCSS('height', '28px');
      await expect(mWithAddons.locator('[data-ui-name="Button.Text"]')).toHaveCSS('font-size', '14px');
      await expect(mWithAddons.locator('[data-ui-name="Button.Text"]')).toHaveCSS('margin-left', '8px');
      await expect(mWithAddons.locator('[data-ui-name="Button.Text"]')).toHaveCSS('margin-right', '8px');
    });
