...
- Version patch update due to children dependencies update (`@semcore/utils` [3.47.1 ~> 3.47.2], `@semcore/icon` [3.13.2 ~> 3.13.3], `@semcore/flex-box` [4.7.10 ~> 4.7.11], `@semcore/scroll-area` [4.2.10 ~> 4.2.11]).
