...
- Version patch update due to children dependencies update (`@semcore/utils` [3.48.0 ~> 3.48.1], `@semcore/icon` [3.14.2 ~> 3.14.3], `@semcore/flex-box` [4.7.14 ~> 4.7.15], `@semcore/scroll-area` [4.2.14 ~> 4.2.15]).
