...
- Version patch update due to children dependencies update (`@semcore/utils` [3.46.1 ~> 3.47.0], `@semcore/icon` [3.10.0 ~> 3.10.1], `@semcore/flex-box` [4.7.8 ~> 4.7.9], `@semcore/scroll-area` [4.2.8 ~> 4.2.9]).
