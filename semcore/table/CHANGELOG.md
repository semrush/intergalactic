...
- Version minor update due to children dependencies update (`@semcore/utils` [4.48.5 ~> 4.49.0], `@semcore/icon` [4.62.1 ~> 4.63.0], `@semcore/flex-box` [5.41.4 ~> 5.42.0], `@semcore/scroll-area` [5.45.4 ~> 5.46.0], `@semcore/core` [2.39.4 ~> 2.40.0]).
...
- Version patch update due to children dependencies update (`@semcore/utils` [4.48.1 ~> 4.48.2], `@semcore/icon` [4.60.1 ~> 4.60.2], `@semcore/flex-box` [5.41.1 ~> 5.41.2], `@semcore/scroll-area` [5.45.1 ~> 5.45.2], `@semcore/core` [2.39.1 ~> 2.39.2]).

## [4.53.1] - 2025-03-20

### Changed

- Version patch update due to children dependencies update (`@semcore/utils` [4.48.0 ~> 4.48.1], `@semcore/icon` [4.60.0 ~> 4.60.1], `@semcore/flex-box` [5.41.0 ~> 5.41.1], `@semcore/scroll-area` [5.45.0 ~> 5.45.1], `@semcore/core` [2.39.0 ~> 2.39.1]).
...
- Version patch update due to children dependencies update (`@semcore/utils` [4.45.0 ~> 4.45.1], `@semcore/icon` [4.57.0 ~> 4.57.1], `@semcore/flex-box` [5.40.0 ~> 5.40.1], `@semcore/scroll-area` [5.44.0 ~> 5.44.1], `@semcore/core` [2.38.0 ~> 2.38.1]).
...
- Version minor update due to children dependencies update (`@semcore/utils` [4.44.1 ~> 4.45.0], `@semcore/icon` [4.55.0 ~> 4.56.0], `@semcore/flex-box` [5.39.1 ~> 5.40.0], `@semcore/scroll-area` [5.43.1 ~> 5.44.0], `@semcore/core` [2.37.1 ~> 2.38.0]).
...
- Version patch update due to children dependencies update (`@semcore/utils` [4.44.0 ~> 4.44.1], `@semcore/icon` [4.53.0 ~> 4.53.1], `@semcore/flex-box` [5.39.0 ~> 5.39.1], `@semcore/scroll-area` [5.43.0 ~> 5.43.1], `@semcore/core` [2.37.0 ~> 2.37.1]).

## [4.49.0] - 2024-11-29

### Changed

- Version minor update due to children dependencies update (`@semcore/utils` [4.43.3 ~> 4.44.0], `@semcore/icon` [4.52.2 ~> 4.53.0], `@semcore/flex-box` [5.38.2 ~> 5.39.0], `@semcore/scroll-area` [5.42.2 ~> 5.43.0], `@semcore/core` [2.36.2 ~> 2.37.0]).

## [4.48.2] - 2024-11-22

### Changed

- Version patch update due to children dependencies update (`@semcore/utils` [4.43.2 ~> 4.43.3], `@semcore/icon` [4.52.1 ~> 4.52.2], `@semcore/flex-box` [5.38.1 ~> 5.38.2], `@semcore/scroll-area` [5.42.1 ~> 5.42.2], `@semcore/core` [2.36.1 ~> 2.36.2]).

## [4.48.1] - 2024-11-08

### Changed

- Version patch update due to children dependencies update (`@semcore/utils` [4.43.0 ~> 4.43.2], `@semcore/icon` [4.52.0 ~> 4.52.1], `@semcore/flex-box` [5.38.0 ~> 5.38.1], `@semcore/scroll-area` [5.42.0 ~> 5.42.1], `@semcore/core` [2.36.0 ~> 2.36.1]).

## [4.48.0] - 2024-11-01

### Changed

- Version minor update due to children dependencies update (`@semcore/utils` [4.42.0 ~> 4.43.0], `@semcore/icon` [4.51.0 ~> 4.52.0], `@semcore/flex-box` [5.37.0 ~> 5.38.0], `@semcore/scroll-area` [5.41.0 ~> 5.42.0], `@semcore/core` [2.35.0 ~> 2.36.0]).

## [4.47.0] - 2024-10-28

### Changed

- Version minor update due to children dependencies update (`@semcore/utils` [4.41.0 ~> 4.42.0], `@semcore/icon` [4.50.0 ~> 4.51.0], `@semcore/flex-box` [5.36.0 ~> 5.37.0], `@semcore/scroll-area` [5.40.0 ~> 5.41.0], `@semcore/core` [2.34.0 ~> 2.35.0]).

## [4.46.0] - 2024-10-18

### Changed

- Version minor update due to children dependencies update (`@semcore/utils` [4.39.0 ~> 4.41.0], `@semcore/icon` [4.48.0 ~> 4.50.0], `@semcore/flex-box` [5.35.0 ~> 5.36.0], `@semcore/scroll-area` [5.39.0 ~> 5.40.0], `@semcore/core` [2.33.0 ~> 2.34.0]).

## [4.45.0] - 2024-10-11

### Changed

- Version minor update due to children dependencies update (`@semcore/utils` [4.38.0 ~> 4.39.0], `@semcore/icon` [4.47.0 ~> 4.48.0], `@semcore/flex-box` [5.34.0 ~> 5.35.0], `@semcore/scroll-area` [5.38.0 ~> 5.39.0], `@semcore/core` [2.32.0 ~> 2.33.0]).

## [4.44.0] - 2024-10-04

### Changed

- Version minor update due to children dependencies update (`@semcore/utils` [4.36.2 ~> 4.38.0], `@semcore/icon` [4.46.0 ~> 4.47.0], `@semcore/flex-box` [5.33.1 ~> 5.34.0], `@semcore/scroll-area` [5.37.1 ~> 5.38.0], `@semcore/core` [2.31.1 ~> 2.32.0]).

## [4.43.1] - 2024-09-27

### Changed

- Version patch update due to children dependencies update (`@semcore/utils` [4.36.0 ~> 4.36.2], `@semcore/icon` [4.45.0 ~> 4.46.0], `@semcore/flex-box` [5.33.0 ~> 5.33.1], `@semcore/scroll-area` [5.37.0 ~> 5.37.1], `@semcore/core` [2.31.0 ~> 2.31.1]).

## [4.43.0] - 2024-09-20

### Changed

- Version minor update due to children dependencies update (`@semcore/utils` [4.35.0 ~> 4.36.0], `@semcore/icon` [4.44.1 ~> 4.45.0], `@semcore/flex-box` [5.32.0 ~> 5.33.0], `@semcore/scroll-area` [5.36.0 ~> 5.37.0], `@semcore/core` [2.30.0 ~> 2.31.0]).

## [4.42.1] - 2024-09-06

### Changed

- Version patch update due to children dependencies update (`@semcore/utils` [4.32.2 ~> 4.35.0], `@semcore/icon` [4.44.0 ~> 4.44.1], `@semcore/flex-box` [5.31.2 ~> 5.32.0], `@semcore/scroll-area` [5.35.0 ~> 5.36.0], `@semcore/core` [2.29.2 ~> 2.30.0]).
...
- Version patch update due to children dependencies update (`@semcore/utils` [4.32.1 ~> 4.32.2], `@semcore/icon` [4.43.1 ~> 4.43.2], `@semcore/flex-box` [5.31.1 ~> 5.31.2], `@semcore/scroll-area` [5.34.1 ~> 5.35.0], `@semcore/core` [2.29.1 ~> 2.29.2]).

## [4.41.1] - 2024-07-30

### Changed

- Version patch update due to children dependencies update (`@semcore/utils` [4.32.0 ~> 4.32.1], `@semcore/icon` [4.43.0 ~> 4.43.1], `@semcore/flex-box` [5.31.0 ~> 5.31.1], `@semcore/scroll-area` [5.34.0 ~> 5.34.1], `@semcore/core` [2.29.0 ~> 2.29.1]).

## [4.41.0] - 2024-07-26

### Changed

- Version minor update due to children dependencies update (`@semcore/utils` [4.31.0 ~> 4.32.0], `@semcore/icon` [4.42.0 ~> 4.43.0], `@semcore/flex-box` [5.30.0 ~> 5.31.0], `@semcore/scroll-area` [5.33.1 ~> 5.34.0], `@semcore/core` [2.28.0 ~> 2.29.0]).
...
- Version minor update due to children dependencies update (`@semcore/utils` [4.30.0 ~> 4.31.0], `@semcore/icon` [4.41.0 ~> 4.42.0], `@semcore/flex-box` [5.29.0 ~> 5.30.0], `@semcore/scroll-area` [5.32.0 ~> 5.33.0], `@semcore/core` [2.27.0 ~> 2.28.0]).
...
- Version minor update due to children dependencies update (`@semcore/utils` [4.29.0 ~> 4.30.0], `@semcore/icon` [4.38.0 ~> 4.39.1], `@semcore/flex-box` [5.28.0 ~> 5.29.0], `@semcore/scroll-area` [5.31.0 ~> 5.32.0], `@semcore/core` [2.26.0 ~> 2.27.0]).
...
- Version patch update due to children dependencies update (`@semcore/utils` [4.28.0 ~> 4.28.1], `@semcore/icon` [4.36.0 ~> 4.36.1], `@semcore/flex-box` [5.27.0 ~> 5.27.1], `@semcore/scroll-area` [5.29.0 ~> 5.29.1], `@semcore/core` [2.25.0 ~> 2.25.1]).

## [4.35.0] - 2024-05-23

### Changed

- Version minor update due to children dependencies update (`@semcore/utils` [4.27.0 ~> 4.28.0], `@semcore/icon` [4.35.0 ~> 4.36.0], `@semcore/flex-box` [5.26.0 ~> 5.27.0], `@semcore/scroll-area` [5.28.0 ~> 5.29.0], `@semcore/core` [2.24.0 ~> 2.25.0]).

## [4.34.0] - 2024-05-22

### Changed

- Version minor update due to children dependencies update (`@semcore/utils` [4.26.2 ~> 4.27.0], `@semcore/icon` [4.34.1 ~> 4.35.0], `@semcore/flex-box` [5.25.1 ~> 5.26.0], `@semcore/scroll-area` [5.27.1 ~> 5.28.0], `@semcore/core` [2.23.1 ~> 2.24.0]).

## [4.33.1] - 2024-05-17

### Changed

- Version patch update due to children dependencies update (`@semcore/utils` [4.26.1 ~> 4.26.2], `@semcore/icon` [4.34.0 ~> 4.34.1], `@semcore/flex-box` [5.25.0 ~> 5.25.1], `@semcore/scroll-area` [5.27.0 ~> 5.27.1], `@semcore/core` [2.23.0 ~> 2.23.1]).
...
- Version patch update due to children dependencies update (`@semcore/utils` [4.23.0 ~> 4.23.1], `@semcore/icon` [4.31.0 ~> 4.31.1], `@semcore/flex-box` [5.22.0 ~> 5.22.1], `@semcore/scroll-area` [5.24.0 ~> 5.24.1], `@semcore/core` [2.20.0 ~> 2.20.1]).

## [4.30.0] - 2024-04-15

### Changed

- Version minor update due to children dependencies update (`@semcore/utils` [4.22.2 ~> 4.23.0], `@semcore/icon` [4.30.2 ~> 4.31.0], `@semcore/flex-box` [5.21.2 ~> 5.22.0], `@semcore/scroll-area` [5.23.2 ~> 5.24.0], `@semcore/core` [2.19.2 ~> 2.20.0]).

## [4.29.2] - 2024-04-10

### Changed

- Version patch update due to children dependencies update (`@semcore/utils` [4.22.1 ~> 4.22.2], `@semcore/icon` [4.30.1 ~> 4.30.2], `@semcore/flex-box` [5.21.1 ~> 5.21.2], `@semcore/scroll-area` [5.23.1 ~> 5.23.2], `@semcore/core` [2.19.1 ~> 2.19.2]).

## [4.29.1] - 2024-04-09

### Changed

- Version patch update due to children dependencies update (`@semcore/utils` [4.22.0 ~> 4.22.1], `@semcore/icon` [4.30.0 ~> 4.30.1], `@semcore/flex-box` [5.21.0 ~> 5.21.1], `@semcore/scroll-area` [5.23.0 ~> 5.23.1], `@semcore/core` [2.19.0 ~> 2.19.1]).

## [4.29.0] - 2024-03-27

### Changed

- Version minor update due to children dependencies update (`@semcore/utils` [4.21.1 ~> 4.22.0], `@semcore/icon` [4.29.1 ~> 4.30.0], `@semcore/flex-box` [5.20.1 ~> 5.21.0], `@semcore/scroll-area` [5.22.1 ~> 5.23.0], `@semcore/core` [2.18.1 ~> 2.19.0]).

## [4.28.1] - 2024-03-26

### Changed

- Version patch update due to children dependencies update (`@semcore/utils` [4.21.0 ~> 4.21.1], `@semcore/icon` [4.29.0 ~> 4.29.1], `@semcore/flex-box` [5.20.0 ~> 5.20.1], `@semcore/scroll-area` [5.22.0 ~> 5.22.1], `@semcore/core` [2.18.0 ~> 2.18.1]).
...
- Version preminor update due to children dependencies update (`@semcore/utils` [4.18.0 ~> 4.19.0], `@semcore/icon` [4.22.0 ~> 4.23.0], `@semcore/flex-box` [5.16.0 ~> 5.17.0], `@semcore/scroll-area` [5.18.0 ~> 5.19.0], `@semcore/core` [2.15.0 ~> 2.16.0]).
...
- Version prepatch update due to children dependencies update (`@semcore/utils` [4.10.1 ~> 4.10.2], `@semcore/icon` [4.14.0 ~> 4.14.1], `@semcore/flex-box` [5.10.0 ~> 5.10.1], `@semcore/scroll-area` [5.12.0 ~> 5.12.1], `@semcore/core` [2.9.0 ~> 2.9.1]).
