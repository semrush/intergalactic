...
- Version minor update due to children dependencies update (`@semcore/utils` [4.45.1 ~> 4.47.1], `@semcore/icon` [4.57.1 ~> 4.58.0], `@semcore/flex-box` [5.40.1 ~> 5.41.0], `@semcore/scroll-area` [5.44.1 ~> 5.45.0], `@semcore/core` [2.38.1 ~> 2.39.0]).
