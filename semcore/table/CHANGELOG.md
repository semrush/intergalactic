...
- Version patch update due to children dependencies update (`@semcore/utils` [3.39.0 ~> 3.39.1], `@semcore/icon` [3.0.1 ~> 3.0.2], `@semcore/flex-box` [4.6.1 ~> 4.6.2], `@semcore/scroll-area` [4.1.1 ~> 4.1.2]).
