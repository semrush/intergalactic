...
- Version patch update due to children dependencies update (`@semcore/utils` [3.49.0 ~> 3.49.1], `@semcore/icon` [3.14.4 ~> 3.14.5], `@semcore/flex-box` [4.7.16 ~> 4.7.17], `@semcore/scroll-area` [4.2.16 ~> 4.2.17]).
