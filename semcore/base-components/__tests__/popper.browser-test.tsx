...
test.describe('Popper', () => {
  test('Focus lock', async ({ page }) => {
    const standPath = 'semcore/base-components/__tests__/popper-stands/dropdown.tsx';
  ...
  test('Focus lock with disablePortal', async ({ page, browserName }) => {
    ...
    const standPath = 'semcore/base-components/__tests__/popper-stands/disable-portal.tsx';
    const htmlContent = await e2eStandToHtml(standPath, 'en');
  ...
  test('cursor anchoring', async ({ page }) => {
    const standPath = 'semcore/base-components/__tests__/popper-stands/cursor-anchoring.tsx';
    const htmlContent = await e2eStandToHtml(standPath, 'en');
  ...
  test.describe('label', () => {
    test('referenced', async ({ page }) => {
      const standPath = 'semcore/base-components/__tests__/popper-stands/label-referenced.tsx';
      const htmlContent = await e2eStandToHtml(standPath, 'en');
    ...
    test('wrapped', async ({ page }) => {
      const standPath = 'semcore/base-components/__tests__/popper-stands/label-wrapped.tsx';
      const htmlContent = await e2eStandToHtml(standPath, 'en');
    ...
    test('wrapped with disable portal', async ({ page }) => {
      const standPath =
        'semcore/base-components/__tests__/popper-stands/label-wrapped-disable-portal.tsx';
      const htmlContent = await e2eStandToHtml(standPath, 'en');
  ...
  test('page resizing', async ({ page }) => {
    const standPath = 'semcore/base-components/__tests__/popper-stands/page-resizing.tsx';
    const htmlContent = await e2eStandToHtml(standPath, 'en');
  ...
  test('works well with multiple focusables inside of trigger', async ({ page }) => {
    const standPath =
      'semcore/base-components/__tests__/popper-stands/multiple-focusables-in-trigger.tsx';
    const htmlContent = await e2eStandToHtml(standPath, 'en');
  ...
  test('Should open popper second time', async ({ page }) => {
    const standPath = 'semcore/base-components/__tests__/popper-stands/focus-interaction.tsx';
    const htmlContent = await e2eStandToHtml(standPath, 'en');
