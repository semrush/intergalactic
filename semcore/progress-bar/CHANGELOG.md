...
- Base background have become darker.
...
- Deprecated atomic types. Atomic parts are part of `NSProgressBar`
namespace.
...
- Version patch update due to children dependencies update (`@semcore/flex-box` [16.0.10 ~> 16.0.11], `@semcore/base-components` [16.4.0 ~> 16.4.1]).
...
- Version patch update due to children dependencies update (`@semcore/flex-box` [16.0.5 ~> 16.0.6], `@semcore/base-components` [16.1.2 ~> 16.2.0]).
...
- Version patch update due to children dependencies update (`@semcore/flex-box` [16.0.2 ~> 16.0.3], `@semcore/base-components` [16.0.2 ~> 16.1.0]).
...
- Version patch update due to children dependencies update (`@semcore/flex-box` [5.41.2 ~> 5.41.3], `@semcore/utils` [4.48.2 ~> 4.48.4], `@semcore/core` [2.39.2 ~> 2.39.3]).
...
- Version minor update due to children dependencies update (`@semcore/flex-box` [5.39.1 ~> 5.40.0], `@semcore/utils` [4.44.1 ~> 4.45.0], `@semcore/core` [2.37.1 ~> 2.38.0]).
...
- Version minor update due to children dependencies update (`@semcore/flex-box` [5.31.2 ~> 5.32.0], `@semcore/utils` [4.32.2 ~> 4.35.0], `@semcore/core` [2.29.2 ~> 2.30.0]).

## [4.30.2] - 2024-08-05

### Changed

- Version patch update due to children dependencies update (`@semcore/flex-box` [5.31.1 ~> 5.31.2], `@semcore/utils` [4.32.1 ~> 4.32.2], `@semcore/core` [2.29.1 ~> 2.29.2]).
...
- Version minor update due to children dependencies update (`@semcore/flex-box` [5.29.0 ~> 5.30.0], `@semcore/utils` [4.30.0 ~> 4.31.0], `@semcore/core` [2.27.0 ~> 2.28.0]).

## [4.28.0] - 2024-06-26

### Changed

- Version minor update due to children dependencies update (`@semcore/flex-box` [5.28.0 ~> 5.29.0], `@semcore/utils` [4.29.0 ~> 4.30.0], `@semcore/core` [2.26.0 ~> 2.27.0]).
...
- Version patch update due to children dependencies update (`@semcore/flex-box` [5.27.1 ~> 5.27.2], `@semcore/utils` [4.28.1 ~> 4.28.2], `@semcore/core` [2.25.1 ~> 2.25.2]).
...
- Version minor update due to children dependencies update (`@semcore/flex-box` [5.24.0 ~> 5.25.0], `@semcore/utils` [4.25.0 ~> 4.26.1], `@semcore/core` [2.22.0 ~> 2.23.0]).
