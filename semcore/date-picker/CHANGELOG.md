...
- Version patch update due to children dependencies update (`@semcore/base-trigger` [16.4.2 ~> 16.4.3], `@semcore/button` [16.0.10 ~> 16.0.11], `@semcore/checkbox` [16.2.0 ~> 16.2.1], `@semcore/tooltip` [16.0.10 ~> 16.0.11], `@semcore/base-components` [16.4.0 ~> 16.4.1]).
...
- Version patch update due to children dependencies update (`@semcore/base-trigger` [16.4.0 ~> 16.4.1], `@semcore/button` [16.0.8 ~> 16.0.9], `@semcore/checkbox` [16.1.2 ~> 16.1.3], `@semcore/base-components` [16.2.2 ~> 16.2.3]).

## [16.1.8] - 2025-09-05

### Changed

- Version patch update due to children dependencies update (`@semcore/base-trigger` [16.3.1 ~> 16.4.0], `@semcore/button` [16.0.7 ~> 16.0.8], `@semcore/icon` [16.6.0 ~> 16.7.0], `@semcore/checkbox` [16.1.1 ~> 16.1.2], `@semcore/base-components` [16.2.1 ~> 16.2.2]).
...
- Version patch update due to children dependencies update (`@semcore/base-trigger` [16.2.3 ~> 16.2.4], `@semcore/button` [16.0.4 ~> 16.0.5], `@semcore/icon` [16.2.3 ~> 16.4.0], `@semcore/input` [16.0.4 ~> 16.0.5], `@semcore/checkbox` [16.0.4 ~> 16.0.5], `@semcore/tooltip` [16.0.4 ~> 16.0.5], `@semcore/base-components` [16.1.1 ~> 16.1.2]).

## [16.1.4] - 2025-07-04

### Changed

- Version patch update due to children dependencies update (`@semcore/base-trigger` [16.2.2 ~> 16.2.3], `@semcore/button` [16.0.3 ~> 16.0.4], `@semcore/icon` [16.2.2 ~> 16.2.3], `@semcore/checkbox` [16.0.3 ~> 16.0.4], `@semcore/tooltip` [16.0.3 ~> 16.0.4], `@semcore/base-components` [16.1.0 ~> 16.1.1]).

## [16.1.3] - 2025-06-23

### Changed

- Version patch update due to children dependencies update (`@semcore/base-trigger` [16.2.1 ~> 16.2.2], `@semcore/button` [16.0.2 ~> 16.0.3], `@semcore/dropdown` [16.0.2 ~> 16.0.3], `@semcore/checkbox` [16.0.2 ~> 16.0.3], `@semcore/base-components` [16.0.2 ~> 16.1.0]).

## [16.1.2] - 2025-06-16

### Changed

- Version patch update due to children dependencies update (`@semcore/base-trigger` [16.2.0 ~> 16.2.1], `@semcore/button` [16.0.1 ~> 16.0.2], `@semcore/divider` [16.0.1 ~> 16.0.2], `@semcore/dropdown` [16.0.1 ~> 16.0.2], `@semcore/checkbox` [16.0.1 ~> 16.0.2], `@semcore/base-components` [16.0.1 ~> 16.0.2]).

## [16.1.1] - 2025-05-30

### Changed

- Version patch update due to children dependencies update (`@semcore/base-trigger` [16.1.0 ~> 16.2.0], `@semcore/button` [16.0.0 ~> 16.0.1], `@semcore/icon` [16.1.0 ~> 16.2.0], `@semcore/checkbox` [16.0.0 ~> 16.0.1], `@semcore/base-components` [16.0.0 ~> 16.0.1]).
