...
- Version patch update due to children dependencies update (`@semcore/spin` [16.0.9 ~> 16.0.10], `@semcore/flex-box` [16.0.9 ~> 16.0.10], `@semcore/animation` [16.0.5 ~> 16.0.6], `@semcore/base-components` [16.2.3 ~> 16.4.0]).

## [16.0.9] - 2025-09-17

### Changed

- Version patch update due to children dependencies update (`@semcore/spin` [16.0.8 ~> 16.0.9], `@semcore/flex-box` [16.0.8 ~> 16.0.9], `@semcore/base-components` [16.2.2 ~> 16.2.3]).

## [16.0.8] - 2025-09-05

### Changed

- Version patch update due to children dependencies update (`@semcore/spin` [16.0.7 ~> 16.0.8], `@semcore/flex-box` [16.0.7 ~> 16.0.8], `@semcore/base-components` [16.2.1 ~> 16.2.2]).

## [16.0.7] - 2025-08-29

### Changed

- Version patch update due to children dependencies update (`@semcore/spin` [16.0.6 ~> 16.0.7], `@semcore/flex-box` [16.0.6 ~> 16.0.7], `@semcore/animation` [16.0.4 ~> 16.0.5], `@semcore/base-components` [16.2.0 ~> 16.2.1]).

## [16.0.6] - 2025-08-07

### Changed

- Version patch update due to children dependencies update (`@semcore/spin` [16.0.5 ~> 16.0.6], `@semcore/flex-box` [16.0.5 ~> 16.0.6], `@semcore/animation` [16.0.3 ~> 16.0.4], `@semcore/base-components` [16.1.2 ~> 16.2.0]).

## [16.0.5] - 2025-07-23

### Changed

- Version patch update due to children dependencies update (`@semcore/spin` [16.0.4 ~> 16.0.5], `@semcore/flex-box` [16.0.4 ~> 16.0.5], `@semcore/base-components` [16.1.1 ~> 16.1.2]).

## [16.0.4] - 2025-07-04

### Changed

- Version patch update due to children dependencies update (`@semcore/spin` [16.0.3 ~> 16.0.4], `@semcore/flex-box` [16.0.3 ~> 16.0.4], `@semcore/base-components` [16.1.0 ~> 16.1.1]).

## [16.0.3] - 2025-06-23

### Changed

- Version patch update due to children dependencies update (`@semcore/spin` [16.0.2 ~> 16.0.3], `@semcore/flex-box` [16.0.2 ~> 16.0.3], `@semcore/animation` [16.0.2 ~> 16.0.3], `@semcore/base-components` [16.0.2 ~> 16.1.0]).
...
- Version patch update due to children dependencies update (`@semcore/spin` [16.0.0 ~> 16.0.1], `@semcore/flex-box` [16.0.0 ~> 16.0.1], `@semcore/animation` [16.0.0 ~> 16.0.1], `@semcore/base-components` [16.0.0 ~> 16.0.1]).
...
- Version patch update due to children dependencies update (`@semcore/utils` [4.48.4 ~> 4.48.5], `@semcore/spin` [5.41.3 ~> 5.41.4], `@semcore/flex-box` [5.41.3 ~> 5.41.4], `@semcore/animation` [2.41.3 ~> 2.41.4], `@semcore/core` [2.39.3 ~> 2.39.4]).

## [7.41.3] - 2025-05-09

### Changed

- Version patch update due to children dependencies update (`@semcore/utils` [4.48.2 ~> 4.48.4], `@semcore/spin` [5.41.2 ~> 5.41.3], `@semcore/flex-box` [5.41.2 ~> 5.41.3], `@semcore/animation` [2.41.2 ~> 2.41.3], `@semcore/core` [2.39.2 ~> 2.39.3]).

## [7.41.2] - 2025-04-04

### Changed

- Version patch update due to children dependencies update (`@semcore/utils` [4.48.1 ~> 4.48.2], `@semcore/spin` [5.41.1 ~> 5.41.2], `@semcore/flex-box` [5.41.1 ~> 5.41.2], `@semcore/animation` [2.41.1 ~> 2.41.2], `@semcore/core` [2.39.1 ~> 2.39.2]).
