...
- Version minor update due to children dependencies update (`@semcore/utils` [4.45.1 ~> 4.47.1], `@semcore/flex-box` [5.40.1 ~> 5.41.0], `@semcore/popper` [5.45.3 ~> 5.46.0], `@semcore/icon` [4.57.1 ~> 4.58.0], `@semcore/animation` [2.40.1 ~> 2.41.0], `@semcore/core` [2.38.1 ~> 2.39.0]).
