...
- Version patch update due to children dependencies update (`@semcore/button` [5.42.0 ~> 5.42.1], `@semcore/utils` [4.48.0 ~> 4.48.1], `@semcore/animation` [2.41.0 ~> 2.41.1], `@semcore/core` [2.39.0 ~> 2.39.1]).
