...
## [5.27.2-prerelease.1] - 2024-02-21

### Changed

- Version prerelease update due to children dependencies update (`@semcore/icon` [4.26.1-prerelease.1 ~> 4.26.1], `@semcore/flex-box` [5.19.2-prerelease.1 ~> 5.19.2], `@semcore/core` [2.17.3-prerelease.1 ~> 2.17.3]).
