...
- Version minor update due to children dependencies update (`@semcore/typography` [16.2.3 ~> 16.3.0], `@semcore/base-components` [16.2.3 ~> 16.4.0]).

## [16.6.1] - 2025-09-17

### Changed

- Version patch update due to children dependencies update (`@semcore/button` [16.0.8 ~> 16.0.9]).
...
- Version minor update due to children dependencies update (`@semcore/icon` [16.4.0 ~> 16.5.0], `@semcore/typography` [16.1.5 ~> 16.2.0], `@semcore/base-components` [16.1.2 ~> 16.2.0]).

## [16.3.0] - 2025-07-23

### Changed

- Version minor update due to children dependencies update (`@semcore/icon` [16.2.3 ~> 16.4.0]).

## [16.2.3] - 2025-07-04

### Changed

- Version patch update due to children dependencies update (`@semcore/icon` [16.2.2 ~> 16.2.3]).
