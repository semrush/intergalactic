...
- Version patch update due to children dependencies update (`@semcore/animation` [16.0.6 ~> 16.0.7], `@semcore/button` [16.0.10 ~> 16.0.11], `@semcore/flex-box` [16.0.10 ~> 16.0.11], `@semcore/portal` [16.0.10 ~> 16.0.11], `@semcore/outside-click` [16.0.10 ~> 16.0.11], `@semcore/icon` [16.5.1 ~> 16.5.2], `@semcore/base-components` [16.4.0 ~> 16.4.1]).
