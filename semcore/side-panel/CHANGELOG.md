...
- Header height doesn't increase as content increases.
...
- Version patch update due to children dependencies update (`@semcore/animation` [16.0.6 ~> 16.0.7], `@semcore/button` [16.0.10 ~> 16.0.11], `@semcore/flex-box` [16.0.10 ~> 16.0.11], `@semcore/portal` [16.0.10 ~> 16.0.11], `@semcore/outside-click` [16.0.10 ~> 16.0.11], `@semcore/icon` [16.5.1 ~> 16.7.2], `@semcore/base-components` [16.4.0 ~> 16.4.1]).
...
- Version patch update due to children dependencies update (`@semcore/button` [16.0.7 ~> 16.0.8], `@semcore/flex-box` [16.0.7 ~> 16.0.8], `@semcore/portal` [16.0.7 ~> 16.0.8], `@semcore/outside-click` [16.0.7 ~> 16.0.8], `@semcore/icon` [16.6.0 ~> 16.7.0], `@semcore/base-components` [16.2.1 ~> 16.2.2]).
...
- Version patch update due to children dependencies update (`@semcore/button` [16.0.4 ~> 16.0.5], `@semcore/flex-box` [16.0.4 ~> 16.0.5], `@semcore/portal` [16.0.4 ~> 16.0.5], `@semcore/outside-click` [16.0.4 ~> 16.0.5], `@semcore/icon` [16.2.3 ~> 16.4.0], `@semcore/base-components` [16.1.1 ~> 16.1.2]).

## [16.1.4] - 2025-07-04

### Changed

- Version patch update due to children dependencies update (`@semcore/button` [16.0.3 ~> 16.0.4], `@semcore/flex-box` [16.0.3 ~> 16.0.4], `@semcore/portal` [16.0.3 ~> 16.0.4], `@semcore/outside-click` [16.0.3 ~> 16.0.4], `@semcore/icon` [16.2.2 ~> 16.2.3], `@semcore/base-components` [16.1.0 ~> 16.1.1]).

## [16.1.3] - 2025-06-23

### Changed

- Version patch update due to children dependencies update (`@semcore/animation` [16.0.2 ~> 16.0.3], `@semcore/button` [16.0.2 ~> 16.0.3], `@semcore/flex-box` [16.0.2 ~> 16.0.3], `@semcore/portal` [16.0.2 ~> 16.0.3], `@semcore/outside-click` [16.0.2 ~> 16.0.3], `@semcore/icon` [16.2.1 ~> 16.2.2], `@semcore/base-components` [16.0.2 ~> 16.1.0]).

## [16.1.2] - 2025-06-16

### Changed

- Version patch update due to children dependencies update (`@semcore/animation` [16.0.1 ~> 16.0.2], `@semcore/button` [16.0.1 ~> 16.0.2], `@semcore/flex-box` [16.0.1 ~> 16.0.2], `@semcore/portal` [16.0.1 ~> 16.0.2], `@semcore/outside-click` [16.0.1 ~> 16.0.2], `@semcore/icon` [16.2.0 ~> 16.2.1], `@semcore/base-components` [16.0.1 ~> 16.0.2]).

## [16.1.1] - 2025-05-30

### Changed

- Version patch update due to children dependencies update (`@semcore/animation` [16.0.0 ~> 16.0.1], `@semcore/button` [16.0.0 ~> 16.0.1], `@semcore/flex-box` [16.0.0 ~> 16.0.1], `@semcore/portal` [16.0.0 ~> 16.0.1], `@semcore/outside-click` [16.0.0 ~> 16.0.1], `@semcore/icon` [16.1.0 ~> 16.2.0], `@semcore/base-components` [16.0.0 ~> 16.0.1]).
...
- Version minor update due to children dependencies update (`@semcore/utils` [4.22.2 ~> 4.23.0], `@semcore/animation` [2.21.2 ~> 2.22.0], `@semcore/flex-box` [5.21.2 ~> 5.22.0], `@semcore/portal` [3.21.2 ~> 3.22.0], `@semcore/outside-click` [3.19.2 ~> 3.20.0], `@semcore/icon` [4.30.2 ~> 4.31.0], `@semcore/core` [2.19.2 ~> 2.20.0]).
