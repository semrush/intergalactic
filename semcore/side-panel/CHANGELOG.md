...
- Version patch update due to children dependencies update (`@semcore/utils` [3.47.3 ~> 3.47.4], `@semcore/animation` [1.9.4 ~> 1.9.5], `@semcore/flex-box` [4.7.12 ~> 4.7.13], `@semcore/portal` [2.5.11 ~> 2.5.12], `@semcore/outside-click` [2.5.17 ~> 2.5.18], `@semcore/icon` [3.14.0 ~> 3.14.1]).
