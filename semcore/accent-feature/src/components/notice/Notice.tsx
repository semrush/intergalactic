...
class NoticeAFRoot extends Component<NoticeSmartProps> {
  static displayName = 'NoticeAF';
  static style = style;
...
export const NoticeAF = createComponent(NoticeAFRoot);
