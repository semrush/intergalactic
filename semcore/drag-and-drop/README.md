...
[![version](https://img.shields.io/npm/v/@semcore/drag-and-drop.svg)](https://www.npmjs.com/@semcore/drag-and-drop)
[![downloads](https://img.shields.io/npm/dt/@semcore/drag-and-drop.svg)](https://www.npmjs.com/package/@semcore/drag-and-drop)
...
### 📖 [Component documentation](https://developer.semrush.com/intergalactic/components/drag-and-drop/)
...
```sh
npm install @semcore/drag-and-drop @semcore/core
```
