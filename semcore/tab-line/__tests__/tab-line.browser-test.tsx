...
test.describe(`${TAG.VISUAL} `, () => {
  ...
  const variablesEllipsis = [
    ...
    { w: 100, size: 'm', behavior: 'auto', ellipsis: { cropPosition: 'middle' }, hintPlacement: 'right', desc: 'cropPosition:middle' },
    { w: 100, size: 'l', behavior: 'manual', hintPlacement: 'right', desc: 'default' },
    { w: 100, size: 'm', behavior: 'manual', ellipsis: { cropPosition: 'middle' }, hintPlacement: 'right', desc: 'cropPosition:middle' },
  ];
