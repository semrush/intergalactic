...
- Version patch update due to children dependencies update (`@semcore/tooltip` [16.0.3 ~> 16.0.4], `@semcore/base-components` [16.1.0 ~> 16.1.1]).
...
- `white-space` property to `pre` for preserve spacing.
...
- Version minor update due to children dependencies update (`@semcore/utils` [4.32.2 ~> 4.35.0], `@semcore/tooltip` [6.40.4 ~> 6.41.0], `@semcore/core` [2.29.2 ~> 2.30.0]).
...
- Version patch update due to children dependencies update (`@semcore/utils` [4.32.1 ~> 4.32.2], `@semcore/tooltip` [6.40.1 ~> 6.40.2], `@semcore/core` [2.29.1 ~> 2.29.2]).
...
- Version minor update due to children dependencies update (`@semcore/utils` [4.31.0 ~> 4.32.0], `@semcore/tooltip` [6.39.1 ~> 6.40.0], `@semcore/core` [2.28.0 ~> 2.29.0]).
...
- Version patch update due to children dependencies update (`@semcore/tooltip` [6.34.1 ~> 6.34.3]).

## [2.28.1] - 2024-05-28

### Changed

- Version patch update due to children dependencies update (`@semcore/utils` [4.28.0 ~> 4.28.1], `@semcore/tooltip` [6.33.3 ~> 6.34.0], `@semcore/core` [2.25.0 ~> 2.25.1]).
...
- Version minor update due to children dependencies update (`@semcore/utils` [4.20.5 ~> 4.21.0], `@semcore/tooltip` [6.22.0 ~> 6.23.0], `@semcore/core` [2.17.5 ~> 2.18.0]).

## [2.19.4] - 2024-03-06

### Changed

- Version prepatch update due to children dependencies update (`@semcore/utils` [4.20.4 ~> 4.20.5], `@semcore/tooltip` [6.20.3 ~> 6.21.0], `@semcore/core` [2.17.4 ~> 2.17.5]).
