...
- Version patch update due to children dependencies update (`@semcore/animation` [16.0.6 ~> 16.0.7], `@semcore/base-components` [16.4.0 ~> 16.4.1]).

## [16.0.10] - 2025-10-06

### Changed

- Version patch update due to children dependencies update (`@semcore/animation` [16.0.5 ~> 16.0.6], `@semcore/base-components` [16.2.3 ~> 16.4.0]).
...
- Version patch update due to children dependencies update (`@semcore/animation` [16.0.4 ~> 16.0.5], `@semcore/base-components` [16.2.0 ~> 16.2.1]).

## [16.0.6] - 2025-08-07

### Changed

- Version patch update due to children dependencies update (`@semcore/animation` [16.0.3 ~> 16.0.4], `@semcore/base-components` [16.1.2 ~> 16.2.0]).
...
- Version patch update due to children dependencies update (`@semcore/animation` [16.0.2 ~> 16.0.3], `@semcore/base-components` [16.0.2 ~> 16.1.0]).

## [16.0.2] - 2025-06-16

### Changed

- Version patch update due to children dependencies update (`@semcore/animation` [16.0.1 ~> 16.0.2], `@semcore/base-components` [16.0.1 ~> 16.0.2]).

## [16.0.1] - 2025-05-30

### Changed

- Version patch update due to children dependencies update (`@semcore/animation` [16.0.0 ~> 16.0.1], `@semcore/base-components` [16.0.0 ~> 16.0.1]).
...
- Version patch update due to children dependencies update (`@semcore/animation` [2.41.3 ~> 2.41.4], `@semcore/utils` [4.48.4 ~> 4.48.5], `@semcore/core` [2.39.3 ~> 2.39.4]).

## [5.40.3] - 2025-05-09

### Changed

- Version patch update due to children dependencies update (`@semcore/animation` [2.41.2 ~> 2.41.3], `@semcore/utils` [4.48.2 ~> 4.48.4], `@semcore/core` [2.39.2 ~> 2.39.3]).

## [5.40.2] - 2025-04-04

### Changed

- Version patch update due to children dependencies update (`@semcore/animation` [2.41.1 ~> 2.41.2], `@semcore/utils` [4.48.1 ~> 4.48.2], `@semcore/core` [2.39.1 ~> 2.39.2]).

## [5.40.1] - 2025-03-20

### Changed

- Version patch update due to children dependencies update (`@semcore/animation` [2.41.0 ~> 2.41.1], `@semcore/utils` [4.48.0 ~> 4.48.1], `@semcore/core` [2.39.0 ~> 2.39.1]).
...
- Version patch update due to children dependencies update (`@semcore/animation` [2.31.1 ~> 2.31.2], `@semcore/utils` [4.32.1 ~> 4.32.2], `@semcore/core` [2.29.1 ~> 2.29.2]).
...
- Version minor update due to children dependencies update (`@semcore/animation` [2.30.0 ~> 2.31.0], `@semcore/utils` [4.31.0 ~> 4.32.0], `@semcore/core` [2.28.0 ~> 2.29.0]).
...
- Version minor update due to children dependencies update (`@semcore/animation` [2.28.0 ~> 2.29.0], `@semcore/utils` [4.29.0 ~> 4.30.0], `@semcore/core` [2.26.0 ~> 2.27.0]).
...
- Version patch update due to children dependencies update (`@semcore/animation` [2.27.0 ~> 2.27.1], `@semcore/utils` [4.28.0 ~> 4.28.1], `@semcore/core` [2.25.0 ~> 2.25.1]).
...
- Version minor update due to children dependencies update (`@semcore/animation` [2.22.2 ~> 2.23.0], `@semcore/utils` [4.23.2 ~> 4.24.0], `@semcore/core` [2.20.2 ~> 2.21.0]).

## [5.21.2] - 2024-04-22

### Changed

- Version patch update due to children dependencies update (`@semcore/animation` [2.22.1 ~> 2.22.2], `@semcore/utils` [4.23.1 ~> 4.23.2], `@semcore/core` [2.20.1 ~> 2.20.2]).

## [5.21.1] - 2024-04-16

### Changed

- Version patch update due to children dependencies update (`@semcore/animation` [2.22.0 ~> 2.22.1], `@semcore/utils` [4.23.0 ~> 4.23.1], `@semcore/core` [2.20.0 ~> 2.20.1]).

## [5.21.0] - 2024-04-15

### Changed

- Version minor update due to children dependencies update (`@semcore/animation` [2.21.2 ~> 2.22.0], `@semcore/utils` [4.22.2 ~> 4.23.0], `@semcore/core` [2.19.2 ~> 2.20.0]).
...
- Version patch update due to children dependencies update (`@semcore/animation` [2.21.0 ~> 2.21.1], `@semcore/utils` [4.22.0 ~> 4.22.1], `@semcore/core` [2.19.0 ~> 2.19.1]).
...
- Version patch update due to children dependencies update (`@semcore/animation` [2.20.0 ~> 2.20.1], `@semcore/portal` [3.18.0 ~> 3.20.0], `@semcore/utils` [4.21.0 ~> 4.21.1], `@semcore/core` [2.18.0 ~> 2.18.1]).

## [5.19.0] - 2024-03-15

### Changed

- Version minor update due to children dependencies update (`@semcore/animation` [2.19.2 ~> 2.20.0], `@semcore/utils` [4.20.5 ~> 4.21.0], `@semcore/core` [2.17.5 ~> 2.18.0]).
...
- Version prepatch update due to children dependencies update (`@semcore/animation` [2.19.0 ~> 2.19.1], `@semcore/utils` [4.20.4 ~> 4.20.5], `@semcore/core` [2.17.4 ~> 2.17.5]).

## [5.18.4] - 2024-03-01

### Changed

- Version prepatch update due to children dependencies update (`@semcore/animation` [2.18.3 ~> 2.19.0], `@semcore/utils` [4.20.3 ~> 4.20.4], `@semcore/core` [2.17.3 ~> 2.17.4]).
...
## [1.0.0-prerelease.10] - 2018-12-26
