...
- Version minor update due to children dependencies update (`@semcore/animation` [2.40.1 ~> 2.41.0], `@semcore/flex-box` [5.40.1 ~> 5.41.0], `@semcore/utils` [4.45.1 ~> 4.47.1], `@semcore/core` [2.38.1 ~> 2.39.0]).
