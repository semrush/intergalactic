...
- Calculate `Text` width based on the number of added `Icons` as Addons.
...
- This is now an inline element. The inline property is no longer applicable.
- `noWrap` is now false by default.
- `hintPlacement` property added.
- Link.Text is now a Text element; all text customization should be done within it. Link is simply a container.
- New major version.
...
- Version patch update due to children dependencies update (`@semcore/flex-box` [16.0.10 ~> 16.0.11], `@semcore/tooltip` [16.0.10 ~> 16.0.11], `@semcore/base-components` [16.4.0 ~> 16.4.1]).

## [16.0.10] - 2025-10-06

### Changed

- Version patch update due to children dependencies update (`@semcore/flex-box` [16.0.9 ~> 16.0.10], `@semcore/typography` [16.2.3 ~> 16.3.0], `@semcore/base-components` [16.2.3 ~> 16.4.0]).
...
- Version patch update due to children dependencies update (`@semcore/flex-box` [16.0.6 ~> 16.0.7], `@semcore/base-components` [16.2.0 ~> 16.2.1]).
...
- Version patch update due to children dependencies update (`@semcore/flex-box` [16.0.4 ~> 16.0.5], `@semcore/tooltip` [16.0.4 ~> 16.0.5], `@semcore/base-components` [16.1.1 ~> 16.1.2]).

## [16.0.4] - 2025-07-04

### Changed

- Version patch update due to children dependencies update (`@semcore/flex-box` [16.0.3 ~> 16.0.4], `@semcore/tooltip` [16.0.3 ~> 16.0.4], `@semcore/base-components` [16.1.0 ~> 16.1.1]).
...
- Version minor update due to children dependencies update (`@semcore/utils` [4.32.2 ~> 4.35.0], `@semcore/flex-box` [5.31.2 ~> 5.32.0], `@semcore/tooltip` [6.40.4 ~> 6.41.0], `@semcore/core` [2.29.2 ~> 2.30.0]).
...
- Version patch update due to children dependencies update (`@semcore/utils` [4.32.1 ~> 4.32.2], `@semcore/flex-box` [5.31.1 ~> 5.31.2], `@semcore/tooltip` [6.40.1 ~> 6.40.2], `@semcore/core` [2.29.1 ~> 2.29.2]).
...
- Version minor update due to children dependencies update (`@semcore/utils` [4.31.0 ~> 4.32.0], `@semcore/flex-box` [5.30.0 ~> 5.31.0], `@semcore/tooltip` [6.39.1 ~> 6.40.0], `@semcore/core` [2.28.0 ~> 2.29.0]).
...
- Version patch update due to children dependencies update (`@semcore/tooltip` [6.36.0 ~> 6.36.1]).
