export default {
  ...
  '--intergalactic-header-border-primary': 'transparent',
  '--intergalactic-header-border-secondary': 'rgba(255, 255, 255, 0.15)',
  '--intergalactic-header-control-secondary': '#4D407E',
  '--intergalactic-header-control-secondary-hover': '#6D619F',
  '--intergalactic-header-control-secondary-active': '#8379ad',
  '--intergalactic-header-control-tertiary-hover': '#4D407E',
  '--intergalactic-header-control-tertiary-active': '#6D619F',
