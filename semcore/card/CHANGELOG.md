...
- Version patch update due to children dependencies update (`@semcore/tooltip` [16.0.10 ~> 16.0.11], `@semcore/button` [16.0.10 ~> 16.0.11], `@semcore/icon` [16.5.1 ~> 16.7.2], `@semcore/base-components` [16.4.0 ~> 16.4.1]).
...
- Version patch update due to children dependencies update (`@semcore/button` [16.0.7 ~> 16.0.8], `@semcore/icon` [16.6.0 ~> 16.7.0], `@semcore/base-components` [16.2.1 ~> 16.2.2]).

## [16.1.7] - 2025-08-29

### Changed

- Version patch update due to children dependencies update (`@semcore/button` [16.0.6 ~> 16.0.7], `@semcore/icon` [16.5.0 ~> 16.6.0], `@semcore/base-components` [16.2.0 ~> 16.2.1]).

## [16.1.6] - 2025-08-07

### Changed

- Version patch update due to children dependencies update (`@semcore/typography` [16.1.5 ~> 16.2.0], `@semcore/button` [16.0.5 ~> 16.0.6], `@semcore/icon` [16.4.0 ~> 16.5.0], `@semcore/base-components` [16.1.2 ~> 16.2.0]).

## [16.1.5] - 2025-07-23

### Changed

- Version patch update due to children dependencies update (`@semcore/tooltip` [16.0.4 ~> 16.0.5], `@semcore/button` [16.0.4 ~> 16.0.5], `@semcore/icon` [16.2.3 ~> 16.4.0], `@semcore/base-components` [16.1.1 ~> 16.1.2]).

## [16.1.4] - 2025-07-04

### Changed

- Version patch update due to children dependencies update (`@semcore/tooltip` [16.0.3 ~> 16.0.4], `@semcore/button` [16.0.3 ~> 16.0.4], `@semcore/icon` [16.2.2 ~> 16.2.3], `@semcore/base-components` [16.1.0 ~> 16.1.1]).
...
- Version patch update due to children dependencies update (`@semcore/button` [16.0.1 ~> 16.0.2], `@semcore/base-components` [16.0.1 ~> 16.0.2]).

## [16.1.1] - 2025-05-30

### Changed

- Version patch update due to children dependencies update (`@semcore/button` [16.0.0 ~> 16.0.1], `@semcore/icon` [16.1.0 ~> 16.2.0], `@semcore/base-components` [16.0.0 ~> 16.0.1]).
...
- Version patch update due to children dependencies update (`@semcore/utils` [4.48.4 ~> 4.48.5], `@semcore/button` [5.43.2 ~> 5.43.3]).

## [5.48.1] - 2025-05-09

### Changed

- Version patch update due to children dependencies update (`@semcore/utils` [4.48.2 ~> 4.48.4], `@semcore/button` [5.43.1 ~> 5.43.2], `@semcore/icon` [4.61.0 ~> 4.62.0]).
...
- Version patch update due to children dependencies update (`@semcore/utils` [4.48.1 ~> 4.48.2], `@semcore/button` [5.43.0 ~> 5.43.1]).
...
- Version patch update due to children dependencies update (`@semcore/utils` [4.48.0 ~> 4.48.1], `@semcore/button` [5.42.0 ~> 5.42.1], `@semcore/icon` [4.60.0 ~> 4.60.1]).
...
- Version patch update due to children dependencies update (`@semcore/utils` [4.45.0 ~> 4.45.1], `@semcore/flex-box` [5.40.0 ~> 5.40.1], `@semcore/button` [5.41.1 ~> 5.41.2]).
...
- Version minor update due to children dependencies update (`@semcore/utils` [4.44.1 ~> 4.45.0], `@semcore/button` [5.40.3 ~> 5.41.0]).
...
- Version patch update due to children dependencies update (`@semcore/utils` [4.44.0 ~> 4.44.1], `@semcore/tooltip` [6.47.0 ~> 6.47.1], `@semcore/button` [5.40.1 ~> 5.40.2]).
...
- Version minor update due to children dependencies update (`@semcore/utils` [4.43.3 ~> 4.44.0], `@semcore/flex-box` [5.38.2 ~> 5.39.0], `@semcore/button` [5.39.4 ~> 5.40.0]).

## [5.43.4] - 2024-11-18

### Changed

- Description for `innerHint` and `hintAfter` properties.

## [5.43.3] - 2024-11-18

### Changed

- Version patch update due to children dependencies update (`@semcore/tooltip` [6.46.1 ~> 6.46.2], `@semcore/button` [5.39.2 ~> 5.39.3]).

## [5.43.2] - 2024-11-08

### Changed

- Version patch update due to children dependencies update (`@semcore/utils` [4.43.0 ~> 4.43.2], `@semcore/tooltip` [6.46.0 ~> 6.46.1], `@semcore/button` [5.39.1 ~> 5.39.2]).

## [5.43.1] - 2024-11-01

### Changed

- Version patch update due to children dependencies update (`@semcore/utils` [4.42.0 ~> 4.43.0], `@semcore/button` [5.39.0 ~> 5.39.1], `@semcore/icon` [4.51.0 ~> 4.52.0]).

## [5.43.0] - 2024-10-28

### Changed

- Version minor update due to children dependencies update (`@semcore/utils` [4.41.0 ~> 4.42.0], `@semcore/button` [5.38.0 ~> 5.39.0]).

## [5.42.0] - 2024-10-18

### Changed

- Version minor update due to children dependencies update (`@semcore/utils` [4.39.0 ~> 4.41.0], `@semcore/button` [5.37.3 ~> 5.38.0], `@semcore/icon` [4.48.0 ~> 4.50.0]).
...
- Version patch update due to children dependencies update (`@semcore/utils` [4.36.0 ~> 4.36.2], `@semcore/button` [5.37.0 ~> 5.37.1], `@semcore/icon` [4.45.0 ~> 4.46.0]).

## [5.41.0] - 2024-08-29

### Changed

- Render hints in header with `ButtonLink` component.
...
- Version patch update due to children dependencies update (`@semcore/tooltip` [6.40.3 ~> 6.40.4], `@semcore/icon` [4.43.2 ~> 4.44.0]).
...
- Version patch update due to children dependencies update (`@semcore/utils` [4.32.1 ~> 4.32.2], `@semcore/tooltip` [6.40.1 ~> 6.40.2]).
...
- Version minor update due to children dependencies update (`@semcore/utils` [4.31.0 ~> 4.32.0], `@semcore/tooltip` [6.39.1 ~> 6.40.0]).
...
- Version patch update due to children dependencies update (`@semcore/tooltip` [6.36.0 ~> 6.36.1], `@semcore/icon` [4.39.1 ~> 4.41.0]).

## [5.37.0] - 2024-06-26

### Changed

- Version minor update due to children dependencies update (`@semcore/utils` [4.29.0 ~> 4.30.0], `@semcore/icon` [4.38.0 ~> 4.39.1]).
...
- Version patch update due to children dependencies update (`@semcore/utils` [4.28.0 ~> 4.28.1], `@semcore/tooltip` [6.33.3 ~> 6.34.0]).
...
- Version minor update due to children dependencies update (`@semcore/utils` [4.23.2 ~> 4.24.0], `@semcore/typography` [5.30.2 ~> 5.31.0], `@semcore/tooltip` [6.26.2 ~> 6.27.0]).
...
- Version patch update due to children dependencies update (`@semcore/tooltip` [6.24.0 ~> 6.24.1], `@semcore/icon` [4.28.0 ~> 4.29.0]).

## [5.27.1] - 2024-03-19

### Changed

- Version patch update due to children dependencies update (`@semcore/typography` [5.27.0 ~> 5.27.1], `@semcore/tooltip` [6.23.0 ~> 6.24.0]).

## [5.27.0] - 2024-03-15

### Changed

- Version minor update due to children dependencies update (`@semcore/utils` [4.20.5 ~> 4.21.0], `@semcore/tooltip` [6.22.0 ~> 6.23.0], `@semcore/icon` [4.27.1 ~> 4.28.0]).

## [5.26.1] - 2024-03-06

### Changed

- Version prepatch update due to children dependencies update (`@semcore/utils` [4.20.4 ~> 4.20.5], `@semcore/tooltip` [6.20.3 ~> 6.21.0], `@semcore/icon` [4.27.0 ~> 4.27.1]).
...
- Version preminor update due to children dependencies update (`@semcore/tooltip` [6.19.0 ~> 6.20.0], `@semcore/icon` [4.25.0 ~> 4.26.0]).

## [5.24.2] - 2024-02-09

### Changed

- Version prepatch update due to children dependencies update (`@semcore/utils` [4.20.1 ~> 4.20.2], `@semcore/tooltip` [6.18.1 ~> 6.19.0], `@semcore/icon` [4.24.1 ~> 4.25.0]).
...
- Version preminor update due to children dependencies update (`@semcore/utils` [4.8.4 ~> 4.9.0], `@semcore/typography` [5.13.0 ~> 5.14.0], `@semcore/tooltip` [6.8.8 ~> 6.9.0], `@semcore/icon` [4.12.0 ~> 4.13.0]).
