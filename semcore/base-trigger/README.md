...
[![version](https://img.shields.io/npm/v/@semcore/base-trigger.svg)](https://www.npmjs.com/@semcore/base-trigger)
[![downloads](https://img.shields.io/npm/dt/@semcore/base-trigger.svg)](https://www.npmjs.com/package/@semcore/base-trigger)
...
### 📖 [Component documentation](https://developer.semrush.com/intergalactic/components/filter-trigger/)
...
```sh
npm install @semcore/base-trigger @semcore/core
```
