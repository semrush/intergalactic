...
test.describe('Button-trigger', () => {
    ...
    test('Styles and propd', async ({ page }) => {
        ...
        const standPath = 'stories/components/base-trigger/tests/examples/button-trigger-all-states.tsx';
  ...
  while (i < count) {
    ...
    i++; 
          ...
          await test.step('Verify roles and attributes', async () => {
            ...
            const placeholderElement = await page.locator('[data-ui-name="ButtonTrigger.Text"][placeholder]').first();
