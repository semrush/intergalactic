...
test.describe(` ${TAG.VISUAL}`, () => {
  ...
  const ellipsisVariants = [
    ...
    { desc: 'cropPosition: middle', vars: { ellipsis: { 'ellipsis': true, 'ellipsis:cropPosition': 'middle' } } },
    { desc: 'middle, lastRequired: 2', vars: { ellipsis: { 'ellipsis': true, 'ellipsis:cropPosition': 'middle', 'ellipsis:lastRequiredSymbols': 2 } } },
  ];
