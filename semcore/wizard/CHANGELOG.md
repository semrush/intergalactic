...
- Version patch update due to children dependencies update (`@semcore/button` [16.0.9 ~> 16.0.10], `@semcore/flex-box` [16.0.9 ~> 16.0.10], `@semcore/icon` [16.7.1 ~> 16.7.2], `@semcore/modal` [16.1.9 ~> 16.1.10], `@semcore/base-components` [16.2.3 ~> 16.3.0]).

## [16.1.9] - 2025-09-17

### Changed

- Version patch update due to children dependencies update (`@semcore/button` [16.0.8 ~> 16.0.9], `@semcore/flex-box` [16.0.8 ~> 16.0.9], `@semcore/icon` [16.7.0 ~> 16.7.1], `@semcore/modal` [16.1.8 ~> 16.1.9], `@semcore/base-components` [16.2.2 ~> 16.2.3]).

## [16.1.8] - 2025-09-05

### Changed

- Version patch update due to children dependencies update (`@semcore/button` [16.0.7 ~> 16.0.8], `@semcore/flex-box` [16.0.7 ~> 16.0.8], `@semcore/icon` [16.6.0 ~> 16.7.0], `@semcore/modal` [16.1.7 ~> 16.1.8], `@semcore/base-components` [16.2.1 ~> 16.2.2]).
...
- Version patch update due to children dependencies update (`@semcore/button` [16.0.5 ~> 16.0.6], `@semcore/flex-box` [16.0.5 ~> 16.0.6], `@semcore/icon` [16.4.0 ~> 16.5.0], `@semcore/modal` [16.1.5 ~> 16.1.6], `@semcore/base-components` [16.1.2 ~> 16.2.0]).

## [16.1.5] - 2025-07-23

### Changed

- Version patch update due to children dependencies update (`@semcore/button` [16.0.4 ~> 16.0.5], `@semcore/flex-box` [16.0.4 ~> 16.0.5], `@semcore/icon` [16.2.3 ~> 16.4.0], `@semcore/modal` [16.1.4 ~> 16.1.5], `@semcore/base-components` [16.1.1 ~> 16.1.2]).

## [16.1.4] - 2025-07-04

### Changed

- Version patch update due to children dependencies update (`@semcore/button` [16.0.3 ~> 16.0.4], `@semcore/flex-box` [16.0.3 ~> 16.0.4], `@semcore/icon` [16.2.2 ~> 16.2.3], `@semcore/modal` [16.1.3 ~> 16.1.4], `@semcore/base-components` [16.1.0 ~> 16.1.1]).

## [16.1.3] - 2025-06-23

### Changed

- Version patch update due to children dependencies update (`@semcore/button` [16.0.2 ~> 16.0.3], `@semcore/flex-box` [16.0.2 ~> 16.0.3], `@semcore/icon` [16.2.1 ~> 16.2.2], `@semcore/modal` [16.1.2 ~> 16.1.3], `@semcore/base-components` [16.0.2 ~> 16.1.0]).

## [16.1.2] - 2025-06-16

### Changed

- Version patch update due to children dependencies update (`@semcore/button` [16.0.1 ~> 16.0.2], `@semcore/flex-box` [16.0.1 ~> 16.0.2], `@semcore/icon` [16.2.0 ~> 16.2.1], `@semcore/modal` [16.1.1 ~> 16.1.2], `@semcore/base-components` [16.0.1 ~> 16.0.2]).

## [16.1.1] - 2025-05-30

### Changed

- Version patch update due to children dependencies update (`@semcore/button` [16.0.0 ~> 16.0.1], `@semcore/flex-box` [16.0.0 ~> 16.0.1], `@semcore/icon` [16.1.0 ~> 16.2.0], `@semcore/modal` [16.1.0 ~> 16.1.1], `@semcore/base-components` [16.0.0 ~> 16.0.1]).
...
- Version patch update due to children dependencies update (`@semcore/utils` [4.45.0 ~> 4.45.1], `@semcore/flex-box` [5.40.0 ~> 5.40.1], `@semcore/icon` [4.57.0 ~> 4.57.1], `@semcore/modal` [4.53.0 ~> 4.53.1], `@semcore/core` [2.38.0 ~> 2.38.1]).

## [2.51.0] - 2025-02-05

### Changed

- Version minor update due to children dependencies update (`@semcore/icon` [4.56.0 ~> 4.57.0], `@semcore/modal` [4.52.0 ~> 4.53.0]).

## [2.50.0] - 2025-02-03

### Changed

- Version minor update due to children dependencies update (`@semcore/utils` [4.44.1 ~> 4.45.0], `@semcore/flex-box` [5.39.1 ~> 5.40.0], `@semcore/icon` [4.55.0 ~> 4.56.0], `@semcore/modal` [4.51.0 ~> 4.52.0], `@semcore/core` [2.37.1 ~> 2.38.0]).

## [2.49.0] - 2025-01-21

### Changed

- Version minor update due to children dependencies update (`@semcore/icon` [4.53.1 ~> 4.55.0], `@semcore/modal` [4.50.1 ~> 4.51.0]).

## [2.48.1] - 2024-12-30

### Changed

- Version patch update due to children dependencies update (`@semcore/utils` [4.44.0 ~> 4.44.1], `@semcore/flex-box` [5.39.0 ~> 5.39.1], `@semcore/icon` [4.53.0 ~> 4.53.1], `@semcore/modal` [4.50.0 ~> 4.50.1], `@semcore/core` [2.37.0 ~> 2.37.1]).

## [2.48.0] - 2024-11-29

### Changed

- Version minor update due to children dependencies update (`@semcore/utils` [4.43.3 ~> 4.44.0], `@semcore/flex-box` [5.38.2 ~> 5.39.0], `@semcore/icon` [4.52.2 ~> 4.53.0], `@semcore/modal` [4.49.3 ~> 4.50.0], `@semcore/core` [2.36.2 ~> 2.37.0]).

## [2.47.3] - 2024-11-22

### Changed

- Version patch update due to children dependencies update (`@semcore/utils` [4.43.2 ~> 4.43.3], `@semcore/flex-box` [5.38.1 ~> 5.38.2], `@semcore/icon` [4.52.1 ~> 4.52.2], `@semcore/modal` [4.49.2 ~> 4.49.3], `@semcore/core` [2.36.1 ~> 2.36.2]).

## [2.47.2] - 2024-11-08

### Changed

- Version patch update due to children dependencies update (`@semcore/utils` [4.43.0 ~> 4.43.2], `@semcore/flex-box` [5.38.0 ~> 5.38.1], `@semcore/icon` [4.52.0 ~> 4.52.1], `@semcore/modal` [4.49.1 ~> 4.49.2], `@semcore/core` [2.36.0 ~> 2.36.1]).

## [2.47.1] - 2024-11-01

### Changed

- Version patch update due to children dependencies update (`@semcore/utils` [4.42.0 ~> 4.43.0], `@semcore/flex-box` [5.37.0 ~> 5.38.0], `@semcore/icon` [4.51.0 ~> 4.52.0], `@semcore/modal` [4.49.0 ~> 4.49.1], `@semcore/core` [2.35.0 ~> 2.36.0]).

## [2.47.0] - 2024-10-28

### Changed

- Version minor update due to children dependencies update (`@semcore/utils` [4.41.0 ~> 4.42.0], `@semcore/flex-box` [5.36.0 ~> 5.37.0], `@semcore/icon` [4.50.0 ~> 4.51.0], `@semcore/modal` [4.48.0 ~> 4.49.0], `@semcore/core` [2.34.0 ~> 2.35.0]).

## [2.46.0] - 2024-10-18

### Changed

- Version minor update due to children dependencies update (`@semcore/utils` [4.39.0 ~> 4.41.0], `@semcore/flex-box` [5.35.0 ~> 5.36.0], `@semcore/icon` [4.48.0 ~> 4.50.0], `@semcore/modal` [4.47.0 ~> 4.48.0], `@semcore/core` [2.33.0 ~> 2.34.0]).

## [2.45.0] - 2024-10-11

### Changed

- Version minor update due to children dependencies update (`@semcore/utils` [4.38.0 ~> 4.39.0], `@semcore/flex-box` [5.34.0 ~> 5.35.0], `@semcore/icon` [4.47.0 ~> 4.48.0], `@semcore/modal` [4.46.0 ~> 4.47.0], `@semcore/core` [2.32.0 ~> 2.33.0]).

## [2.44.2] - 2024-10-03

### Fixed

- Switching wizard steps with arrows.

## [2.44.1] - 2024-09-27

### Changed

- Version patch update due to children dependencies update (`@semcore/utils` [4.36.0 ~> 4.36.2], `@semcore/flex-box` [5.33.0 ~> 5.33.1], `@semcore/icon` [4.45.0 ~> 4.46.0], `@semcore/modal` [4.45.0 ~> 4.45.1], `@semcore/core` [2.31.0 ~> 2.31.1]).

## [2.44.0] - 2024-08-14

### Added

- `Wizard.StepBack` and `Wizard.StepNext` buttons.
- Autofocus on wizard content after step change.

### Changed

- Correct `tab` and `tabpanel` roles connecting of wizard steps and content.

## [2.43.1] - 2024-09-06

### Changed

- Version patch update due to children dependencies update (`@semcore/utils` [4.32.2 ~> 4.35.0], `@semcore/flex-box` [5.31.2 ~> 5.32.0], `@semcore/icon` [4.44.0 ~> 4.44.1], `@semcore/modal` [4.44.0 ~> 4.44.1], `@semcore/core` [2.29.2 ~> 2.30.0]).

## [2.43.0] - 2024-08-23

### Changed

- Version minor update due to children dependencies update (`@semcore/icon` [4.43.2 ~> 4.44.0], `@semcore/modal` [4.43.0 ~> 4.44.0]).

## [2.42.2] - 2024-08-05

### Changed

- Version patch update due to children dependencies update (`@semcore/utils` [4.32.1 ~> 4.32.2], `@semcore/flex-box` [5.31.1 ~> 5.31.2], `@semcore/icon` [4.43.1 ~> 4.43.2], `@semcore/modal` [4.42.1 ~> 4.43.0], `@semcore/core` [2.29.1 ~> 2.29.2]).

## [2.42.1] - 2024-07-30

### Changed

- Version patch update due to children dependencies update (`@semcore/utils` [4.32.0 ~> 4.32.1], `@semcore/flex-box` [5.31.0 ~> 5.31.1], `@semcore/icon` [4.43.0 ~> 4.43.1], `@semcore/modal` [4.42.0 ~> 4.42.1], `@semcore/core` [2.29.0 ~> 2.29.1]).

## [2.42.0] - 2024-07-26

### Changed

- Version minor update due to children dependencies update (`@semcore/utils` [4.31.0 ~> 4.32.0], `@semcore/flex-box` [5.30.0 ~> 5.31.0], `@semcore/icon` [4.42.0 ~> 4.43.0], `@semcore/modal` [4.41.0 ~> 4.42.0], `@semcore/core` [2.28.0 ~> 2.29.0]).

## [2.41.0] - 2024-07-13

### Changed

- Version minor update due to children dependencies update (`@semcore/utils` [4.30.0 ~> 4.31.0], `@semcore/flex-box` [5.29.0 ~> 5.30.0], `@semcore/icon` [4.41.0 ~> 4.42.0], `@semcore/modal` [4.40.0 ~> 4.41.0], `@semcore/core` [2.27.0 ~> 2.28.0]).

## [2.40.0] - 2024-07-05

### Changed

- Version minor update due to children dependencies update (`@semcore/icon` [4.39.1 ~> 4.41.0], `@semcore/modal` [4.39.0 ~> 4.40.0]).

## [2.39.0] - 2024-06-26

### Changed

- Version minor update due to children dependencies update (`@semcore/utils` [4.29.0 ~> 4.30.0], `@semcore/flex-box` [5.28.0 ~> 5.29.0], `@semcore/icon` [4.38.0 ~> 4.39.1], `@semcore/modal` [4.38.0 ~> 4.39.0], `@semcore/core` [2.26.0 ~> 2.27.0]).

## [2.38.0] - 2024-06-13

### Changed

- Version minor update due to children dependencies update (`@semcore/utils` [4.28.2 ~> 4.29.0], `@semcore/flex-box` [5.27.2 ~> 5.28.0], `@semcore/icon` [4.37.0 ~> 4.38.0], `@semcore/modal` [4.37.2 ~> 4.38.0], `@semcore/core` [2.25.2 ~> 2.26.0]).

## [2.37.2] - 2024-06-12

### Changed

- Version patch update due to children dependencies update (`@semcore/utils` [4.28.1 ~> 4.28.2], `@semcore/flex-box` [5.27.1 ~> 5.27.2], `@semcore/icon` [4.36.1 ~> 4.37.0], `@semcore/modal` [4.37.1 ~> 4.37.2], `@semcore/core` [2.25.1 ~> 2.25.2]).

## [2.37.1] - 2024-05-28

### Changed

- Version patch update due to children dependencies update (`@semcore/utils` [4.28.0 ~> 4.28.1], `@semcore/flex-box` [5.27.0 ~> 5.27.1], `@semcore/icon` [4.36.0 ~> 4.36.1], `@semcore/modal` [4.37.0 ~> 4.37.1], `@semcore/core` [2.25.0 ~> 2.25.1]).

## [2.37.0] - 2024-05-23

### Changed

- Version minor update due to children dependencies update (`@semcore/utils` [4.27.0 ~> 4.28.0], `@semcore/flex-box` [5.26.0 ~> 5.27.0], `@semcore/icon` [4.35.0 ~> 4.36.0], `@semcore/modal` [4.36.0 ~> 4.37.0], `@semcore/core` [2.24.0 ~> 2.25.0]).

## [2.36.0] - 2024-05-22

### Changed

- Version minor update due to children dependencies update (`@semcore/utils` [4.26.2 ~> 4.27.0], `@semcore/flex-box` [5.25.1 ~> 5.26.0], `@semcore/icon` [4.34.1 ~> 4.35.0], `@semcore/modal` [4.35.1 ~> 4.36.0], `@semcore/core` [2.23.1 ~> 2.24.0]).

## [2.35.1] - 2024-05-17

### Changed

- Version patch update due to children dependencies update (`@semcore/utils` [4.26.1 ~> 4.26.2], `@semcore/flex-box` [5.25.0 ~> 5.25.1], `@semcore/icon` [4.34.0 ~> 4.34.1], `@semcore/modal` [4.35.0 ~> 4.35.1], `@semcore/core` [2.23.0 ~> 2.23.1]).
...
- Version patch update due to children dependencies update (`@semcore/utils` [4.22.1 ~> 4.22.2], `@semcore/flex-box` [5.21.1 ~> 5.21.2], `@semcore/icon` [4.30.1 ~> 4.30.2], `@semcore/modal` [4.31.1 ~> 4.31.2], `@semcore/core` [2.19.1 ~> 2.19.2]).
...
- Version preminor update due to children dependencies update (`@semcore/icon` [4.15.0 ~> 4.16.0], `@semcore/modal` [4.17.0 ~> 4.18.0]).
...
- Version prepatch update due to children dependencies update (`@semcore/utils` [4.7.1 ~> 4.7.2], `@semcore/flex-box` [5.7.1 ~> 5.7.2], `@semcore/icon` [4.9.1 ~> 4.9.2], `@semcore/modal` [4.11.1 ~> 4.11.2], `@semcore/core` [2.7.1 ~> 2.7.2]).
