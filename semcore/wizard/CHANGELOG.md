...
- Version patch update due to children dependencies update (`@semcore/utils` [3.47.4 ~> 3.48.0], `@semcore/flex-box` [4.7.13 ~> 4.7.14], `@semcore/icon` [3.14.1 ~> 3.14.2], `@semcore/modal` [3.5.11 ~> 3.5.12]).
