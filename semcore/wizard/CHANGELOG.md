...
- Version minor update due to children dependencies update (`@semcore/utils` [4.35.0 ~> 4.36.0], `@semcore/flex-box` [5.32.0 ~> 5.33.0], `@semcore/icon` [4.44.1 ~> 4.45.0], `@semcore/modal` [4.44.1 ~> 4.45.0], `@semcore/core` [2.30.0 ~> 2.31.0]).
