...
- Version patch update due to children dependencies update (`@semcore/flex-box` [16.0.6 ~> 16.0.7], `@semcore/icon` [16.5.0 ~> 16.5.1], `@semcore/base-components` [16.2.0 ~> 16.2.1]).
