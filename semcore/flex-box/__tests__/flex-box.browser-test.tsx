...
test('Check Box margins and paddings', async ({ page }) => {
  ...
  // Check No m/p
  expect(await boxes[0].evaluate((box) => {
  ...
  // Check m={5} p={10}
  expect(await boxes[1].evaluate((box) => {
    const computedStyle = window.getComputedStyle(box);
    return {
      margin: computedStyle.margin,
      padding: computedStyle.padding,
  ...
  expect(await boxes[2].evaluate((box) => {
    const computedStyle = window.getComputedStyle(box);
    return {
      margin: computedStyle.margin,
    };
  ...
  expect(await boxes[3].evaluate((box) => {
    const computedStyle = window.getComputedStyle(box);
    return {
      padding: computedStyle.padding,
    };
  ...
  // Check mx={10}
  expect(await boxes[4].evaluate((box) => {
    const computedStyle = window.getComputedStyle(box);
    return {
      margin: computedStyle.margin,
    };
  ...
  // Check my={10}
  expect(await boxes[5].evaluate((box) => {
    const computedStyle = window.getComputedStyle(box);
    return {
      margin: computedStyle.margin,
    };
  ...
  // Check px={10}
  expect(await boxes[6].evaluate((box) => {
    const computedStyle = window.getComputedStyle(box);
    return {
      padding: computedStyle.padding,
    };
  ...
  // Check py={10}
  expect(await boxes[7].evaluate((box) => {
    const computedStyle = window.getComputedStyle(box);
    return {
      padding: computedStyle.padding,
    };
  ...
  // Check scaleIndent={4}
  expect(await boxes[8].evaluate((box) => {
    const computedStyle = window.getComputedStyle(box);
    return {
      padding: computedStyle.padding,
    };
