...
- Version patch update due to children dependencies update (`@semcore/animation` [1.8.11 ~> 1.9.0], `@semcore/utils` [3.46.1 ~> 3.47.0], `@semcore/flex-box` [4.7.8 ~> 4.7.9], `@semcore/icon` [3.10.0 ~> 3.10.1], `@semcore/notice-global` [1.4.13 ~> 1.5.0]).
