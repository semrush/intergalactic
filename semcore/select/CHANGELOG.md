...
- Version patch update due to children dependencies update (`@semcore/base-trigger` [16.4.3 ~> 16.4.4], `@semcore/button` [16.0.11 ~> 16.0.12], `@semcore/dropdown` [16.1.1 ~> 16.1.3], `@semcore/dropdown-menu` [16.1.12 ~> 16.1.13], `@semcore/icon` [16.7.2 ~> 16.7.3]).
...
- Version patch update due to children dependencies update (`@semcore/base-trigger` [16.4.1 ~> 16.4.2], `@semcore/button` [16.0.9 ~> 16.0.10], `@semcore/checkbox` [16.1.3 ~> 16.2.0], `@semcore/divider` [16.0.9 ~> 16.0.10], `@semcore/dropdown` [16.0.9 ~> 16.1.0], `@semcore/dropdown-menu` [16.1.10 ~> 16.1.11], `@semcore/flex-box` [16.0.9 ~> 16.0.10], `@semcore/icon` [16.5.0 ~> 16.5.1], `@semcore/input` [16.0.9 ~> 16.1.0], `@semcore/popper` [16.0.9 ~> 16.0.10], `@semcore/base-components` [16.2.3 ~> 16.4.0]).

## [16.1.9] - 2025-09-17

### Changed

- Version patch update due to children dependencies update (`@semcore/base-trigger` [16.4.0 ~> 16.4.1], `@semcore/button` [16.0.8 ~> 16.0.9], `@semcore/checkbox` [16.1.2 ~> 16.1.3], `@semcore/divider` [16.0.8 ~> 16.0.9], `@semcore/dropdown` [16.0.8 ~> 16.0.9], `@semcore/dropdown-menu` [16.1.9 ~> 16.1.10], `@semcore/flex-box` [16.0.8 ~> 16.0.9], `@semcore/icon` [16.7.0 ~> 16.7.1], `@semcore/input` [16.0.8 ~> 16.0.9], `@semcore/popper` [16.0.8 ~> 16.0.9], `@semcore/base-components` [16.2.2 ~> 16.2.3]).

## [16.1.8] - 2025-09-05

### Changed

- Version patch update due to children dependencies update (`@semcore/base-trigger` [16.3.1 ~> 16.4.0], `@semcore/button` [16.0.7 ~> 16.0.8], `@semcore/checkbox` [16.1.1 ~> 16.1.2], `@semcore/divider` [16.0.7 ~> 16.0.8], `@semcore/dropdown` [16.0.7 ~> 16.0.8], `@semcore/dropdown-menu` [16.1.8 ~> 16.1.9], `@semcore/flex-box` [16.0.7 ~> 16.0.8], `@semcore/icon` [16.6.0 ~> 16.7.0], `@semcore/input` [16.0.7 ~> 16.0.8], `@semcore/popper` [16.0.7 ~> 16.0.8], `@semcore/base-components` [16.2.1 ~> 16.2.2]).
...
- Version patch update due to children dependencies update (`@semcore/base-trigger` [16.2.4 ~> 16.3.0], `@semcore/button` [16.0.5 ~> 16.0.6], `@semcore/checkbox` [16.0.5 ~> 16.1.0], `@semcore/divider` [16.0.5 ~> 16.0.6], `@semcore/dropdown` [16.0.5 ~> 16.0.6], `@semcore/dropdown-menu` [16.1.6 ~> 16.1.7], `@semcore/flex-box` [16.0.5 ~> 16.0.6], `@semcore/icon` [16.4.0 ~> 16.5.0], `@semcore/input` [16.0.5 ~> 16.0.6], `@semcore/popper` [16.0.5 ~> 16.0.6], `@semcore/base-components` [16.1.2 ~> 16.2.0]).
...
- Version patch update due to children dependencies update (`@semcore/base-trigger` [16.2.2 ~> 16.2.3], `@semcore/button` [16.0.3 ~> 16.0.4], `@semcore/checkbox` [16.0.3 ~> 16.0.4], `@semcore/divider` [16.0.3 ~> 16.0.4], `@semcore/dropdown` [16.0.3 ~> 16.0.4], `@semcore/dropdown-menu` [16.1.4 ~> 16.1.5], `@semcore/flex-box` [16.0.3 ~> 16.0.4], `@semcore/icon` [16.2.2 ~> 16.2.3], `@semcore/input` [16.0.3 ~> 16.0.4], `@semcore/popper` [16.0.3 ~> 16.0.4], `@semcore/base-components` [16.1.0 ~> 16.1.1]).
...
- Version patch update due to children dependencies update (`@semcore/base-trigger` [16.1.0 ~> 16.2.0], `@semcore/button` [16.0.0 ~> 16.0.1], `@semcore/checkbox` [16.0.0 ~> 16.0.1], `@semcore/divider` [16.0.0 ~> 16.0.1], `@semcore/dropdown-menu` [16.1.0 ~> 16.1.1], `@semcore/dropdown` [16.0.0 ~> 16.0.1], `@semcore/icon` [16.1.0 ~> 16.2.0], `@semcore/input` [16.0.0 ~> 16.0.1], `@semcore/popper` [16.0.0 ~> 16.0.1], `@semcore/flex-box` [16.0.0 ~> 16.0.1], `@semcore/base-components` [16.0.0 ~> 16.0.1]).
