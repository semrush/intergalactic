...
- Version patch update due to children dependencies update (`@semcore/select` [16.1.6 ~> 16.1.7], `@semcore/icon` [16.5.0 ~> 16.5.1], `@semcore/dropdown-menu` [16.1.7 ~> 16.1.8], `@semcore/dropdown` [16.0.6 ~> 16.0.7], `@semcore/base-trigger` [16.3.0 ~> 16.3.1], `@semcore/base-components` [16.2.0 ~> 16.2.1]).
