...
- Update base background of the Chart.Bar and CompactHorizontalBar.
- Some states in the Cigarette with empty values.
...
- Version patch update due to children dependencies update (`@semcore/checkbox` [16.1.1 ~> 16.1.2], `@semcore/icon` [16.6.0 ~> 16.7.0], `@semcore/base-components` [16.2.1 ~> 16.2.2]).
