...
test.describe(`${TAG.VISUAL}`, () => {
  ...
  test.describe('Adaptive chart', () => {
    test('Verify chart looks good on small resolutions', {
      ...
      await loadPage(page, 'stories/components/d3-chart/tests/examples/d3-chart/adaptive-props.tsx', 'en');
  ...
  test.describe('Hover Line and Tooltip', () => {
    test('Verify Tooltip and Hover Line appearing and styles by hover ', {
      tag: [TAG.PRIORITY_HIGH, TAG.MOUSE, '@d3-chart'],
    }, async ({ page }) => {
      await loadPage(page, 'stories/components/d3-chart/tests/examples/d3-chart/tooltip-and-hover-line.tsx', 'en');
    ...
    test('Verify Tooltip controlled appearing', {
      ...
      await loadPage(page, 'stories/components/d3-chart/tests/examples/d3-chart/tooltip-control.tsx', 'en');
  ...
  test.describe('Pattern fills, dots and lines', () => {
    test('Verify enforcing patterns', {
      ...
      await loadPage(page, 'stories/components/d3-chart/tests/examples/d3-chart/enforcing-patterns.tsx', 'en');
  ...
  test.describe('Chart legend', () => {
    test('Verify chart leged row', {
      tag: [TAG.PRIORITY_MEDIUM, TAG.MOUSE, '@d3-chart'],
    }, async ({ page }) => {
      await loadPage(page, 'stories/components/d3-chart/tests/examples/chart-legend/shapes-row.tsx', 'en');
    ...
    test('Verify all legend shapes look good', {
      tag: [TAG.PRIORITY_MEDIUM, '@d3-chart'],
    }, async ({ page }) => {
      await loadPage(page, 'stories/components/d3-chart/tests/examples/chart-legend/shapes-column.tsx', 'en');
...
test.describe(`${TAG.FUNCTIONAL}`, () => {
  ...
  test.describe('Pattern fills, dots and lines', () => {
    test('Verify pattern styles', {
      ...
      await loadPage(page, 'stories/components/d3-chart/tests/examples/d3-chart/pattern-fill.tsx', 'en');
