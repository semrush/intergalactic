...
test.describe('Venn chart', () => {
  ...
  test('Verify Custom intersection styles', async ({ page }) => {
    const standPath = 'stories/components/d3-chart/docs/examples/venn-chart/custom-intersection-styles.tsx';
    const htmlContent = await e2eStandToHtml(standPath, 'en');
    await page.setContent(htmlContent);
  ...
  test('Verify Setting orientation', async ({ page }) => {
    const standPath = 'stories/components/d3-chart/docs/examples/venn-chart/setting-orientation.tsx';
    const htmlContent = await e2eStandToHtml(standPath, 'en');
    await page.setContent(htmlContent);
