...
describe('ColorPicker', () => {
  ...
  test.concurrent('Verify input cleared when click on cancel icon inside input', async () => {
  ...
  test.concurrent('Verify color added when click on confirm icon inside input', async () => {
    const spy = vi.fn();
