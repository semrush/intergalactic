...
- `preventDefaultFocusBehavior` property for `DropdownMenu`.
...
- Version patch update due to children dependencies update (`@semcore/button` [16.0.10 ~> 16.0.11], `@semcore/dropdown` [16.1.0 ~> 16.1.1], `@semcore/icon` [16.5.1 ~> 16.7.2], `@semcore/base-components` [16.4.0 ~> 16.4.1]).

## [16.1.11] - 2025-10-06

### Changed

- Version patch update due to children dependencies update (`@semcore/button` [16.0.9 ~> 16.0.10], `@semcore/dropdown` [16.0.9 ~> 16.1.0], `@semcore/typography` [16.2.3 ~> 16.3.0], `@semcore/base-components` [16.2.3 ~> 16.4.0]).

## [16.1.10] - 2025-09-17

### Changed

- Version patch update due to children dependencies update (`@semcore/button` [16.0.8 ~> 16.0.9], `@semcore/dropdown` [16.0.8 ~> 16.0.9], `@semcore/base-components` [16.2.2 ~> 16.2.3]).
...
- Version patch update due to children dependencies update (`@semcore/button` [16.0.5 ~> 16.0.6], `@semcore/dropdown` [16.0.5 ~> 16.0.6], `@semcore/icon` [16.4.0 ~> 16.5.0], `@semcore/typography` [16.1.5 ~> 16.2.0], `@semcore/base-components` [16.1.2 ~> 16.2.0]).

## [16.1.6] - 2025-07-23

### Changed

- Version patch update due to children dependencies update (`@semcore/button` [16.0.4 ~> 16.0.5], `@semcore/dropdown` [16.0.4 ~> 16.0.5], `@semcore/icon` [16.2.3 ~> 16.4.0], `@semcore/base-components` [16.1.1 ~> 16.1.2]).
...
- Version patch update due to children dependencies update (`@semcore/button` [5.43.2 ~> 5.43.3], `@semcore/dropdown` [4.43.3 ~> 4.43.4], `@semcore/utils` [4.48.4 ~> 4.48.5], `@semcore/core` [2.39.3 ~> 2.39.4]).

## [4.48.1] - 2025-05-09

### Changed

- Version patch update due to children dependencies update (`@semcore/button` [5.43.1 ~> 5.43.2], `@semcore/dropdown` [4.43.2 ~> 4.43.3], `@semcore/utils` [4.48.2 ~> 4.48.4], `@semcore/icon` [4.61.0 ~> 4.62.0], `@semcore/core` [2.39.2 ~> 2.39.3]).
...
- Version patch update due to children dependencies update (`@semcore/button` [5.43.0 ~> 5.43.1], `@semcore/dropdown` [4.43.1 ~> 4.43.2], `@semcore/utils` [4.48.1 ~> 4.48.2], `@semcore/core` [2.39.1 ~> 2.39.2]).
...
- Version patch update due to children dependencies update (`@semcore/dropdown` [4.42.2 ~> 4.42.3], `@semcore/flex-box` [5.40.0 ~> 5.40.1], `@semcore/utils` [4.45.0 ~> 4.45.1], `@semcore/core` [2.38.0 ~> 2.38.1]).
...
- Version patch update due to children dependencies update (`@semcore/dropdown` [4.42.1 ~> 4.42.2], `@semcore/utils` [4.44.1 ~> 4.45.0], `@semcore/core` [2.37.1 ~> 2.38.0]).

## [4.44.1] - 2025-01-21

### Changed

- Version patch update due to children dependencies update (`@semcore/dropdown` [4.42.0 ~> 4.42.1], `@semcore/icon` [4.53.1 ~> 4.55.0]).
...
- Version patch update due to children dependencies update (`@semcore/dropdown` [4.37.0 ~> 4.37.1], `@semcore/utils` [4.36.0 ~> 4.36.2], `@semcore/icon` [4.45.0 ~> 4.46.0], `@semcore/core` [2.31.0 ~> 2.31.1]).
...
- Version patch update due to children dependencies update (`@semcore/dropdown` [4.36.0 ~> 4.36.1]).
...
- Version patch update due to children dependencies update (`@semcore/dropdown` [4.34.0 ~> 4.34.1], `@semcore/scroll-area` [5.33.0 ~> 5.33.1]).
...
- Version patch update due to children dependencies update (`@semcore/dropdown` [4.31.5 ~> 4.31.6], `@semcore/scroll-area` [5.29.1 ~> 5.30.0]).

## [4.33.5] - 2024-05-31

### Changed

- Version patch update due to children dependencies update (`@semcore/dropdown` [4.31.4 ~> 4.31.5]).
...
- Version patch update due to children dependencies update (`@semcore/dropdown` [4.24.0 ~> 4.24.1], `@semcore/utils` [4.23.0 ~> 4.23.1], `@semcore/core` [2.20.0 ~> 2.20.1]).

## [4.27.0] - 2024-04-15

### Changed

- Version minor update due to children dependencies update (`@semcore/dropdown` [4.23.3 ~> 4.24.0], `@semcore/scroll-area` [5.23.2 ~> 5.24.0], `@semcore/utils` [4.22.2 ~> 4.23.0], `@semcore/core` [2.19.2 ~> 2.20.0]).

## [4.26.3] - 2024-04-12

### Changed

- Version patch update due to children dependencies update (`@semcore/dropdown` [4.23.2 ~> 4.23.3]).
