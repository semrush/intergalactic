...
- The form wouldn't close when using `Escape` with an error field.
...
- `margin-bottom` of the `Email` illustration in the form success state.

## [16.1.11] - 2025-10-29

### Changed

- Version patch update due to children dependencies update (`@semcore/checkbox` [16.2.0 ~> 16.2.1], `@semcore/icon` [16.5.1 ~> 16.7.2], `@semcore/button` [16.0.10 ~> 16.0.11], `@semcore/tooltip` [16.0.10 ~> 16.0.11], `@semcore/base-components` [16.4.0 ~> 16.4.1]).

## [16.1.10] - 2025-10-06

### Changed

- Version patch update due to children dependencies update (`@semcore/checkbox` [16.1.3 ~> 16.2.0], `@semcore/notice-bubble` [16.1.9 ~> 16.1.10], `@semcore/typography` [16.2.3 ~> 16.3.0], `@semcore/input` [16.0.9 ~> 16.1.0], `@semcore/button` [16.0.9 ~> 16.0.10], `@semcore/base-components` [16.2.3 ~> 16.4.0]).

## [16.1.9] - 2025-09-17

### Changed

- Version patch update due to children dependencies update (`@semcore/checkbox` [16.1.2 ~> 16.1.3], `@semcore/button` [16.0.8 ~> 16.0.9], `@semcore/base-components` [16.2.2 ~> 16.2.3]).

## [16.1.8] - 2025-09-05

### Changed

- Version patch update due to children dependencies update (`@semcore/checkbox` [16.1.1 ~> 16.1.2], `@semcore/icon` [16.6.0 ~> 16.7.0], `@semcore/button` [16.0.7 ~> 16.0.8], `@semcore/base-components` [16.2.1 ~> 16.2.2]).
...
- Version patch update due to children dependencies update (`@semcore/checkbox` [16.0.5 ~> 16.1.0], `@semcore/typography` [16.1.5 ~> 16.2.0], `@semcore/modal` [16.1.5 ~> 16.1.6], `@semcore/icon` [16.4.0 ~> 16.5.0], `@semcore/button` [16.0.5 ~> 16.0.6], `@semcore/base-components` [16.1.2 ~> 16.2.0]).

## [16.1.5] - 2025-07-23

### Changed

- Version patch update due to children dependencies update (`@semcore/checkbox` [16.0.4 ~> 16.0.5], `@semcore/icon` [16.2.3 ~> 16.4.0], `@semcore/input` [16.0.4 ~> 16.0.5], `@semcore/button` [16.0.4 ~> 16.0.5], `@semcore/tooltip` [16.0.4 ~> 16.0.5], `@semcore/base-components` [16.1.1 ~> 16.1.2]).

## [16.1.4] - 2025-07-04

### Changed

- Version patch update due to children dependencies update (`@semcore/checkbox` [16.0.3 ~> 16.0.4], `@semcore/modal` [16.1.3 ~> 16.1.4], `@semcore/icon` [16.2.2 ~> 16.2.3], `@semcore/button` [16.0.3 ~> 16.0.4], `@semcore/tooltip` [16.0.3 ~> 16.0.4], `@semcore/base-components` [16.1.0 ~> 16.1.1]).

## [16.1.3] - 2025-06-23

### Changed

- Version patch update due to children dependencies update (`@semcore/checkbox` [16.0.2 ~> 16.0.3], `@semcore/button` [16.0.2 ~> 16.0.3], `@semcore/base-components` [16.0.2 ~> 16.1.0]).

## [16.1.2] - 2025-06-16

### Changed

- Version patch update due to children dependencies update (`@semcore/checkbox` [16.0.1 ~> 16.0.2], `@semcore/button` [16.0.1 ~> 16.0.2], `@semcore/base-components` [16.0.1 ~> 16.0.2]).
