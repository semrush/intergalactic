...
- Version patch update due to children dependencies update (`@semcore/button` [16.0.10 ~> 16.0.11], `@semcore/icon` [16.5.1 ~> 16.7.2], `@semcore/flex-box` [16.0.10 ~> 16.0.11], `@semcore/animation` [16.0.6 ~> 16.0.7], `@semcore/base-components` [16.4.0 ~> 16.4.1]).

## [16.1.10] - 2025-10-06

### Changed

- Version patch update due to children dependencies update (`@semcore/button` [16.0.9 ~> 16.0.10], `@semcore/icon` [16.5.0 ~> 16.5.1], `@semcore/flex-box` [16.0.9 ~> 16.0.10], `@semcore/animation` [16.0.5 ~> 16.0.6], `@semcore/base-components` [16.2.3 ~> 16.4.0]).
...
- Version patch update due to children dependencies update (`@semcore/button` [16.0.5 ~> 16.0.6], `@semcore/icon` [16.4.0 ~> 16.5.0], `@semcore/flex-box` [16.0.5 ~> 16.0.6], `@semcore/animation` [16.0.3 ~> 16.0.4], `@semcore/base-components` [16.1.2 ~> 16.2.0]).
...
- Version patch update due to children dependencies update (`@semcore/button` [16.0.2 ~> 16.0.3], `@semcore/icon` [16.2.1 ~> 16.2.2], `@semcore/flex-box` [16.0.2 ~> 16.0.3], `@semcore/animation` [16.0.2 ~> 16.0.3], `@semcore/base-components` [16.0.2 ~> 16.1.0]).

## [16.1.2] - 2025-06-16

### Changed

- Version patch update due to children dependencies update (`@semcore/button` [16.0.1 ~> 16.0.2], `@semcore/icon` [16.2.0 ~> 16.2.1], `@semcore/flex-box` [16.0.1 ~> 16.0.2], `@semcore/animation` [16.0.1 ~> 16.0.2], `@semcore/base-components` [16.0.1 ~> 16.0.2]).

## [16.1.1] - 2025-05-30

### Changed

- Version patch update due to children dependencies update (`@semcore/button` [16.0.0 ~> 16.0.1], `@semcore/icon` [16.1.0 ~> 16.2.0], `@semcore/flex-box` [16.0.0 ~> 16.0.1], `@semcore/animation` [16.0.0 ~> 16.0.1], `@semcore/base-components` [16.0.0 ~> 16.0.1]).
...
- Version patch update due to children dependencies update (`@semcore/utils` [4.44.0 ~> 4.44.1], `@semcore/icon` [4.53.0 ~> 4.53.1], `@semcore/flex-box` [5.39.0 ~> 5.39.1], `@semcore/animation` [2.39.0 ~> 2.39.1], `@semcore/core` [2.37.0 ~> 2.37.1]).

## [2.56.0] - 2024-11-29

### Changed

- Version minor update due to children dependencies update (`@semcore/utils` [4.43.3 ~> 4.44.0], `@semcore/icon` [4.52.2 ~> 4.53.0], `@semcore/flex-box` [5.38.2 ~> 5.39.0], `@semcore/animation` [2.38.2 ~> 2.39.0], `@semcore/core` [2.36.2 ~> 2.37.0]).
...
- Version minor update due to children dependencies update (`@semcore/utils` [4.41.0 ~> 4.42.0], `@semcore/icon` [4.50.0 ~> 4.51.0], `@semcore/flex-box` [5.36.0 ~> 5.37.0], `@semcore/animation` [2.36.0 ~> 2.37.0], `@semcore/core` [2.34.0 ~> 2.35.0]).
...
- Version patch update due to children dependencies update (`@semcore/utils` [4.32.2 ~> 4.35.0], `@semcore/icon` [4.44.0 ~> 4.44.1], `@semcore/flex-box` [5.31.2 ~> 5.32.0], `@semcore/animation` [2.31.2 ~> 2.32.0], `@semcore/core` [2.29.2 ~> 2.30.0]).
...
- Version patch update due to children dependencies update (`@semcore/utils` [4.32.0 ~> 4.32.1], `@semcore/icon` [4.43.0 ~> 4.43.1], `@semcore/flex-box` [5.31.0 ~> 5.31.1], `@semcore/animation` [2.31.0 ~> 2.31.1], `@semcore/core` [2.29.0 ~> 2.29.1]).

## [2.48.0] - 2024-07-26

### Changed

- Version minor update due to children dependencies update (`@semcore/utils` [4.31.0 ~> 4.32.0], `@semcore/icon` [4.42.0 ~> 4.43.0], `@semcore/flex-box` [5.30.0 ~> 5.31.0], `@semcore/animation` [2.30.0 ~> 2.31.0], `@semcore/core` [2.28.0 ~> 2.29.0]).
