...
## [4.3.2-beta.0] - 2023-08-14

### Changed

- Version prepatch update due to children dependencies update (`@semcore/button` [5.2.0 ~> 5.2.1], `@semcore/flex-box` [5.2.0 ~> 5.2.1], `@semcore/input` [4.3.0 ~> 4.3.1], `@semcore/select` [4.3.1 ~> 4.3.2], `@semcore/utils` [4.1.0 ~> 4.2.0]).
