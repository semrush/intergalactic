...
const checkStyles = async (element: any, styles: Record<string, string>) => {
  ...
  test.describe('Base styles Primary Table', () => {
    ...
    test('Verify styles when long text and icons in header', async ({ page }) => {
      const standPath = 'stories/components/data-table/tests/examples/header-tests/header-content.tsx';
      const htmlContent = await e2eStandToHtml(standPath, 'en');
  ...
  test.describe('Base styles Secondary Table', () => {
    ...
    test('Verify styles when long text and icons in header', async ({ page }) => {
      const standPath = 'stories/components/data-table/tests/examples/header-tests/secondary-header.tsx';
      const htmlContent = await e2eStandToHtml(standPath, 'en');
    ...
    test('Verify sorting icon style and interactions ', async ({ page, browserName }) => {
      const standPath = 'stories/components/data-table/tests/examples/header-tests/secondary-sorting.tsx';
      const htmlContent = await e2eStandToHtml(standPath, 'en');
