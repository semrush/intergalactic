...
- Version patch update due to children dependencies update (`@semcore/icon` [16.5.1 ~> 16.7.2], `@semcore/button` [16.0.10 ~> 16.0.11], `@semcore/flex-box` [16.0.10 ~> 16.0.11], `@semcore/base-components` [16.4.0 ~> 16.4.1]).

## [16.1.10] - 2025-10-06

### Changed

- Version patch update due to children dependencies update (`@semcore/typography` [16.2.3 ~> 16.3.0], `@semcore/button` [16.0.9 ~> 16.0.10], `@semcore/flex-box` [16.0.9 ~> 16.0.10], `@semcore/base-components` [16.2.3 ~> 16.4.0]).

## [16.1.9] - 2025-09-17

### Changed

- Version patch update due to children dependencies update (`@semcore/button` [16.0.8 ~> 16.0.9], `@semcore/flex-box` [16.0.8 ~> 16.0.9], `@semcore/base-components` [16.2.2 ~> 16.2.3]).

## [16.1.8] - 2025-09-05

### Changed

- Version patch update due to children dependencies update (`@semcore/icon` [16.6.0 ~> 16.7.0], `@semcore/button` [16.0.7 ~> 16.0.8], `@semcore/flex-box` [16.0.7 ~> 16.0.8], `@semcore/base-components` [16.2.1 ~> 16.2.2]).
...
- Version patch update due to children dependencies update (`@semcore/icon` [16.2.3 ~> 16.4.0], `@semcore/button` [16.0.4 ~> 16.0.5], `@semcore/flex-box` [16.0.4 ~> 16.0.5], `@semcore/base-components` [16.1.1 ~> 16.1.2]).

## [16.1.4] - 2025-06-24

### Fixed

- Modal rendered duplicate Close buttons when `closable = true`.

## [16.1.3] - 2025-06-23

### Changed

- Version patch update due to children dependencies update (`@semcore/button` [16.0.2 ~> 16.0.3], `@semcore/flex-box` [16.0.2 ~> 16.0.3], `@semcore/base-components` [16.0.2 ~> 16.1.0]).

## [16.1.2] - 2025-06-16

### Changed

- Version patch update due to children dependencies update (`@semcore/button` [16.0.1 ~> 16.0.2], `@semcore/flex-box` [16.0.1 ~> 16.0.2], `@semcore/base-components` [16.0.1 ~> 16.0.2]).

## [16.1.1] - 2025-05-30

### Changed

- Version patch update due to children dependencies update (`@semcore/icon` [16.1.0 ~> 16.2.0], `@semcore/button` [16.0.0 ~> 16.0.1], `@semcore/flex-box` [16.0.0 ~> 16.0.1], `@semcore/base-components` [16.0.0 ~> 16.0.1]).
...
- Version patch update due to children dependencies update (`@semcore/utils` [4.48.4 ~> 4.48.5], `@semcore/flex-box` [5.41.3 ~> 5.41.4], `@semcore/button` [5.43.2 ~> 5.43.3], `@semcore/core` [2.39.3 ~> 2.39.4]).

## [3.51.1] - 2025-05-09

### Changed

- Version patch update due to children dependencies update (`@semcore/utils` [4.48.2 ~> 4.48.4], `@semcore/icon` [4.61.0 ~> 4.62.0], `@semcore/flex-box` [5.41.2 ~> 5.41.3], `@semcore/button` [5.43.1 ~> 5.43.2], `@semcore/core` [2.39.2 ~> 2.39.3]).
...
- Version patch update due to children dependencies update (`@semcore/utils` [4.48.0 ~> 4.48.1], `@semcore/icon` [4.60.0 ~> 4.60.1], `@semcore/flex-box` [5.41.0 ~> 5.41.1], `@semcore/button` [5.42.0 ~> 5.42.1], `@semcore/core` [2.39.0 ~> 2.39.1]).
...
- Version patch update due to children dependencies update (`@semcore/utils` [4.45.0 ~> 4.45.1], `@semcore/flex-box` [5.40.0 ~> 5.40.1], `@semcore/button` [5.41.1 ~> 5.41.2], `@semcore/core` [2.38.0 ~> 2.38.1]).
...
- Version minor update due to children dependencies update (`@semcore/utils` [4.44.1 ~> 4.45.0], `@semcore/flex-box` [5.39.1 ~> 5.40.0], `@semcore/button` [5.40.3 ~> 5.41.0], `@semcore/core` [2.37.1 ~> 2.38.0]).
...
- Version patch update due to children dependencies update (`@semcore/utils` [4.44.0 ~> 4.44.1], `@semcore/flex-box` [5.39.0 ~> 5.39.1], `@semcore/button` [5.40.1 ~> 5.40.2], `@semcore/core` [2.37.0 ~> 2.37.1]).
...
- Version minor update due to children dependencies update (`@semcore/utils` [4.43.3 ~> 4.44.0], `@semcore/flex-box` [5.38.2 ~> 5.39.0], `@semcore/button` [5.39.4 ~> 5.40.0], `@semcore/core` [2.36.2 ~> 2.37.0]).

## [3.46.4] - 2024-11-22

### Changed

- Version patch update due to children dependencies update (`@semcore/utils` [4.43.2 ~> 4.43.3], `@semcore/flex-box` [5.38.1 ~> 5.38.2], `@semcore/button` [5.39.3 ~> 5.39.4], `@semcore/core` [2.36.1 ~> 2.36.2]).
...
- Version patch update due to children dependencies update (`@semcore/utils` [4.43.0 ~> 4.43.2], `@semcore/flex-box` [5.38.0 ~> 5.38.1], `@semcore/button` [5.39.1 ~> 5.39.2], `@semcore/core` [2.36.0 ~> 2.36.1]).

## [3.46.1] - 2024-11-01

### Changed

- Version patch update due to children dependencies update (`@semcore/utils` [4.42.0 ~> 4.43.0], `@semcore/icon` [4.51.0 ~> 4.52.0], `@semcore/modal` [4.49.0 ~> 4.49.1], `@semcore/flex-box` [5.37.0 ~> 5.38.0], `@semcore/button` [5.39.0 ~> 5.39.1], `@semcore/core` [2.35.0 ~> 2.36.0]).

## [3.46.0] - 2024-10-28

### Changed

- Version minor update due to children dependencies update (`@semcore/utils` [4.41.0 ~> 4.42.0], `@semcore/flex-box` [5.36.0 ~> 5.37.0], `@semcore/button` [5.38.0 ~> 5.39.0], `@semcore/core` [2.34.0 ~> 2.35.0]).

## [3.45.0] - 2024-10-18

### Changed

- Version minor update due to children dependencies update (`@semcore/utils` [4.39.0 ~> 4.41.0], `@semcore/icon` [4.48.0 ~> 4.50.0], `@semcore/flex-box` [5.35.0 ~> 5.36.0], `@semcore/button` [5.37.3 ~> 5.38.0], `@semcore/core` [2.33.0 ~> 2.34.0]).

## [3.44.3] - 2024-10-11

### Changed

- Version patch update due to children dependencies update (`@semcore/utils` [4.38.0 ~> 4.39.0], `@semcore/icon` [4.47.0 ~> 4.48.0], `@semcore/flex-box` [5.34.0 ~> 5.35.0], `@semcore/button` [5.37.2 ~> 5.37.3], `@semcore/core` [2.32.0 ~> 2.33.0]).

## [3.44.2] - 2024-10-04

### Changed

- Version patch update due to children dependencies update (`@semcore/utils` [4.36.2 ~> 4.38.0], `@semcore/flex-box` [5.33.1 ~> 5.34.0], `@semcore/button` [5.37.1 ~> 5.37.2], `@semcore/core` [2.31.1 ~> 2.32.0]).

## [3.44.1] - 2024-09-27

### Changed

- Version patch update due to children dependencies update (`@semcore/utils` [4.36.0 ~> 4.36.2], `@semcore/icon` [4.45.0 ~> 4.46.0], `@semcore/flex-box` [5.33.0 ~> 5.33.1], `@semcore/button` [5.37.0 ~> 5.37.1], `@semcore/core` [2.31.0 ~> 2.31.1]).

## [3.44.0] - 2024-09-20

### Changed

- Version minor update due to children dependencies update (`@semcore/utils` [4.35.0 ~> 4.36.0], `@semcore/flex-box` [5.32.0 ~> 5.33.0], `@semcore/button` [5.36.0 ~> 5.37.0], `@semcore/core` [2.30.0 ~> 2.31.0]).

## [3.43.2] - 2024-09-06

### Changed

- Version patch update due to children dependencies update (`@semcore/utils` [4.32.2 ~> 4.35.0], `@semcore/icon` [4.44.0 ~> 4.44.1], `@semcore/flex-box` [5.31.2 ~> 5.32.0], `@semcore/button` [5.35.2 ~> 5.36.0], `@semcore/core` [2.29.2 ~> 2.30.0]).
...
- Version patch update due to children dependencies update (`@semcore/utils` [4.32.1 ~> 4.32.2], `@semcore/modal` [4.42.1 ~> 4.43.0], `@semcore/flex-box` [5.31.1 ~> 5.31.2], `@semcore/core` [2.29.1 ~> 2.29.2]).
...
- Version minor update due to children dependencies update (`@semcore/utils` [4.31.0 ~> 4.32.0], `@semcore/modal` [4.41.0 ~> 4.42.0], `@semcore/flex-box` [5.30.0 ~> 5.31.0], `@semcore/core` [2.28.0 ~> 2.29.0]).
...
- Version minor update due to children dependencies update (`@semcore/utils` [4.23.2 ~> 4.24.0], `@semcore/typography` [5.30.2 ~> 5.31.0], `@semcore/flex-box` [5.22.2 ~> 5.23.0], `@semcore/core` [2.20.2 ~> 2.21.0]).
...
- Version prepatch update due to children dependencies update (`@semcore/utils` [4.20.4 ~> 4.20.5], `@semcore/icon` [4.27.0 ~> 4.27.1], `@semcore/flex-box` [5.19.3 ~> 5.19.4], `@semcore/core` [2.17.4 ~> 2.17.5]).

## [3.27.4] - 2024-03-01

### Changed

- Version prepatch update due to children dependencies update (`@semcore/utils` [4.20.3 ~> 4.20.4], `@semcore/icon` [4.26.1 ~> 4.27.0], `@semcore/flex-box` [5.19.2 ~> 5.19.3], `@semcore/core` [2.17.3 ~> 2.17.4]).
...
- Version prepatch update due to children dependencies update (`@semcore/utils` [4.20.0 ~> 4.20.1], `@semcore/modal` [4.27.0 ~> 4.27.1], `@semcore/flex-box` [5.18.0 ~> 5.19.0], `@semcore/core` [2.17.0 ~> 2.17.1]).
...
- Version preminor update due to children dependencies update (`@semcore/utils` [4.10.3 ~> 4.13.0], `@semcore/modal` [4.18.1 ~> 4.19.0], `@semcore/flex-box` [5.10.2 ~> 5.11.0], `@semcore/core` [2.9.2 ~> 2.10.0]).
...
- Version preminor update due to children dependencies update (`@semcore/utils` [4.8.4 ~> 4.9.0], `@semcore/icon` [4.12.0 ~> 4.13.0], `@semcore/typography` [5.13.0 ~> 5.14.0], `@semcore/flex-box` [5.8.2 ~> 5.9.0], `@semcore/core` [2.7.7 ~> 2.8.0]).
...
- Version prepatch update due to children dependencies update (`@semcore/utils` [4.6.3 ~> 4.7.0], `@semcore/icon` [4.8.2 ~> 4.8.3], `@semcore/typography` [5.8.2 ~> 5.9.0], `@semcore/flex-box` [5.6.3 ~> 5.7.0], `@semcore/core` [2.6.3 ~> 2.7.0]).
...
- Version prepatch update due to children dependencies update (`@semcore/utils` [4.4.0 ~> 4.4.1], `@semcore/modal` [4.5.0 ~> 4.6.0], `@semcore/flex-box` [5.4.0 ~> 5.4.1], `@semcore/core` [2.4.0 ~> 2.4.1]).

## [3.5.0] - 2023-08-23

### Changed

- Version preminor update due to children dependencies update (`@semcore/utils` [4.3.1 ~> 4.4.0], `@semcore/icon` [4.4.1 ~> 4.5.0], `@semcore/flex-box` [5.3.1 ~> 5.4.0], `@semcore/core` [2.3.1 ~> 2.4.0]).
