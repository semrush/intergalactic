...
[![downloads](https://img.shields.io/npm/dt/@semcore/input-mask.svg)](https://www.npmjs.com/package/@semcore/input-mask)
...
### 📖 [Component documentation](https://developer.semrush.com/intergalactic/components/input-mask/)
...
```sh
npm install @semcore/input-mask @semcore/core
```
