...
- Bubble disappeared on a timer when interacting with it via the
keyboard.
...
- Issue with `replace last item` and `initialAnimation=false`.
...
- Version patch update due to children dependencies update (`@semcore/icon` [16.5.1 ~> 16.7.2], `@semcore/flex-box` [16.0.10 ~> 16.0.11], `@semcore/animation` [16.0.6 ~> 16.0.7], `@semcore/button` [16.0.10 ~> 16.0.11], `@semcore/base-components` [16.4.0 ~> 16.4.1]).
...
- Version patch update due to children dependencies update (`@semcore/icon` [16.7.0 ~> 16.7.1], `@semcore/flex-box` [16.0.8 ~> 16.0.9], `@semcore/button` [16.0.8 ~> 16.0.9], `@semcore/base-components` [16.2.2 ~> 16.2.3]).
...
- Version patch update due to children dependencies update (`@semcore/icon` [16.4.0 ~> 16.5.0], `@semcore/flex-box` [16.0.5 ~> 16.0.6], `@semcore/animation` [16.0.3 ~> 16.0.4], `@semcore/button` [16.0.5 ~> 16.0.6], `@semcore/base-components` [16.1.2 ~> 16.2.0]).

## [16.1.5] - 2025-07-23

### Changed

- Version patch update due to children dependencies update (`@semcore/icon` [16.2.3 ~> 16.4.0], `@semcore/flex-box` [16.0.4 ~> 16.0.5], `@semcore/button` [16.0.4 ~> 16.0.5], `@semcore/base-components` [16.1.1 ~> 16.1.2]).

## [16.1.4] - 2025-07-04

### Changed

- Version patch update due to children dependencies update (`@semcore/icon` [16.2.2 ~> 16.2.3], `@semcore/flex-box` [16.0.3 ~> 16.0.4], `@semcore/button` [16.0.3 ~> 16.0.4], `@semcore/base-components` [16.1.0 ~> 16.1.1]).

## [16.1.3] - 2025-06-23

### Changed

- Version patch update due to children dependencies update (`@semcore/icon` [16.2.1 ~> 16.2.2], `@semcore/flex-box` [16.0.2 ~> 16.0.3], `@semcore/animation` [16.0.2 ~> 16.0.3], `@semcore/button` [16.0.2 ~> 16.0.3], `@semcore/base-components` [16.0.2 ~> 16.1.0]).

## [16.1.2] - 2025-06-16

### Changed

- Version patch update due to children dependencies update (`@semcore/icon` [16.2.0 ~> 16.2.1], `@semcore/flex-box` [16.0.1 ~> 16.0.2], `@semcore/animation` [16.0.1 ~> 16.0.2], `@semcore/button` [16.0.1 ~> 16.0.2], `@semcore/base-components` [16.0.1 ~> 16.0.2]).

## [16.1.1] - 2025-05-30

### Changed

- Version patch update due to children dependencies update (`@semcore/icon` [16.1.0 ~> 16.2.0], `@semcore/flex-box` [16.0.0 ~> 16.0.1], `@semcore/animation` [16.0.0 ~> 16.0.1], `@semcore/button` [16.0.0 ~> 16.0.1], `@semcore/base-components` [16.0.0 ~> 16.0.1]).
