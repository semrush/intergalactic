...
- Version patch update due to children dependencies update (`@semcore/icon` [16.5.1 ~> 16.5.2], `@semcore/flex-box` [16.0.10 ~> 16.0.11], `@semcore/animation` [16.0.6 ~> 16.0.7], `@semcore/button` [16.0.10 ~> 16.0.11], `@semcore/base-components` [16.4.0 ~> 16.4.1]).
