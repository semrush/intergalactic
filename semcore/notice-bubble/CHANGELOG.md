...
- Version patch update due to children dependencies update (`@semcore/icon` [16.7.1 ~> 16.7.2], `@semcore/flex-box` [16.0.9 ~> 16.0.10], `@semcore/animation` [16.0.5 ~> 16.0.6], `@semcore/button` [16.0.9 ~> 16.0.10], `@semcore/base-components` [16.2.3 ~> 16.3.0]).
