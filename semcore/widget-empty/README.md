...
### 📖 [Component documentation](https://developer.semrush.com/intergalactic/components/widget-empty/)
...
```sh
npm install @semcore/widget-empty @semcore/core
```
...
```jsx
import Accordion from '@semcore/widget-empty';
```
