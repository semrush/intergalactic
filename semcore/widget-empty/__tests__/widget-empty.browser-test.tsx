...
test.describe('Widget empty', () => {
    ...
    test('Verify WE inside card without actions renders and have correct attributes', async ({ page }) => {
    ...
    test('Verify WE with text or description and controls', async ({ page }) => {
        ...
        const standPath = 'stories/components/widget-empty/tests/examples/widget-empty-with-controls.tsx';
        const htmlContent = await e2eStandToHtml(standPath, 'en');
