...
- **ellipsis**: Removed unnecessary `margin-bottom` for the widget container.

## [16.0.11] - 2025-10-29

### Changed

- Version patch update due to children dependencies update (`@semcore/flex-box` [16.0.10 ~> 16.0.11], `@semcore/illustration` [16.0.11 ~> 16.0.12], `@semcore/base-components` [16.4.0 ~> 16.4.1]).

## [16.0.10] - 2025-10-06

### Changed

- Version patch update due to children dependencies update (`@semcore/flex-box` [16.0.9 ~> 16.0.10], `@semcore/illustration` [16.0.10 ~> 16.0.11], `@semcore/base-components` [16.2.3 ~> 16.4.0]).

## [16.0.9] - 2025-09-17

### Changed

- Version patch update due to children dependencies update (`@semcore/flex-box` [16.0.8 ~> 16.0.9], `@semcore/illustration` [16.0.9 ~> 16.0.10], `@semcore/base-components` [16.2.2 ~> 16.2.3]).

## [16.0.8] - 2025-09-05

### Changed

- Version patch update due to children dependencies update (`@semcore/flex-box` [16.0.7 ~> 16.0.8], `@semcore/illustration` [16.0.8 ~> 16.0.9], `@semcore/base-components` [16.2.1 ~> 16.2.2]).
...
- Version patch update due to children dependencies update (`@semcore/flex-box` [16.0.5 ~> 16.0.6], `@semcore/illustration` [16.0.6 ~> 16.0.7], `@semcore/base-components` [16.1.2 ~> 16.2.0]).

## [16.0.5] - 2025-07-23

### Changed

- Version patch update due to children dependencies update (`@semcore/flex-box` [16.0.4 ~> 16.0.5], `@semcore/illustration` [16.0.5 ~> 16.0.6], `@semcore/base-components` [16.1.1 ~> 16.1.2]).

## [16.0.4] - 2025-06-26

### Changed

- Text align for `WidgetEmpty.Title` to be always centered.

## [16.0.3] - 2025-06-23

### Changed

- Version patch update due to children dependencies update (`@semcore/flex-box` [16.0.2 ~> 16.0.3], `@semcore/illustration` [16.0.3 ~> 16.0.4], `@semcore/base-components` [16.0.2 ~> 16.1.0]).

## [16.0.2] - 2025-06-16

### Changed

- Version patch update due to children dependencies update (`@semcore/flex-box` [16.0.1 ~> 16.0.2], `@semcore/illustration` [16.0.2 ~> 16.0.3], `@semcore/base-components` [16.0.1 ~> 16.0.2]).

## [16.0.1] - 2025-05-30

### Changed

- Version patch update due to children dependencies update (`@semcore/flex-box` [16.0.0 ~> 16.0.1], `@semcore/illustration` [16.0.1 ~> 16.0.2], `@semcore/base-components` [16.0.0 ~> 16.0.1]).
...
- Version patch update due to children dependencies update (`@semcore/flex-box` [5.41.3 ~> 5.41.4], `@semcore/illustration` [2.44.1 ~> 2.44.2], `@semcore/utils` [4.48.4 ~> 4.48.5], `@semcore/core` [2.39.3 ~> 2.39.4]).

## [4.43.3] - 2025-05-09

### Changed

- Version patch update due to children dependencies update (`@semcore/flex-box` [5.41.2 ~> 5.41.3], `@semcore/illustration` [2.44.0 ~> 2.44.1], `@semcore/utils` [4.48.2 ~> 4.48.4], `@semcore/core` [2.39.2 ~> 2.39.3]).

## [4.43.2] - 2025-04-04

### Changed

- Version patch update due to children dependencies update (`@semcore/flex-box` [5.41.1 ~> 5.41.2], `@semcore/illustration` [2.43.1 ~> 2.44.0], `@semcore/utils` [4.48.1 ~> 4.48.2], `@semcore/core` [2.39.1 ~> 2.39.2]).

## [4.43.1] - 2025-03-20

### Changed

- Version patch update due to children dependencies update (`@semcore/flex-box` [5.41.0 ~> 5.41.1], `@semcore/illustration` [2.43.0 ~> 2.43.1], `@semcore/utils` [4.48.0 ~> 4.48.1], `@semcore/core` [2.39.0 ~> 2.39.1]).
...
- Version patch update due to children dependencies update (`@semcore/flex-box` [5.40.0 ~> 5.40.1], `@semcore/illustration` [2.42.0 ~> 2.42.1], `@semcore/utils` [4.45.0 ~> 4.45.1], `@semcore/core` [2.38.0 ~> 2.38.1]).

## [4.42.0] - 2025-02-03

### Changed

- Version minor update due to children dependencies update (`@semcore/flex-box` [5.39.1 ~> 5.40.0], `@semcore/illustration` [2.41.0 ~> 2.42.0], `@semcore/utils` [4.44.1 ~> 4.45.0], `@semcore/core` [2.37.1 ~> 2.38.0]).

## [4.41.1] - 2024-12-30

### Changed

- Version patch update due to children dependencies update (`@semcore/flex-box` [5.39.0 ~> 5.39.1], `@semcore/illustration` [2.40.0 ~> 2.41.0], `@semcore/utils` [4.44.0 ~> 4.44.1], `@semcore/core` [2.37.0 ~> 2.37.1]).

## [4.41.0] - 2024-11-29

### Changed

- Version minor update due to children dependencies update (`@semcore/flex-box` [5.38.2 ~> 5.39.0], `@semcore/illustration` [2.39.2 ~> 2.40.0], `@semcore/utils` [4.43.3 ~> 4.44.0], `@semcore/core` [2.36.2 ~> 2.37.0]).

## [4.40.2] - 2024-11-22

### Changed

- Version patch update due to children dependencies update (`@semcore/flex-box` [5.38.1 ~> 5.38.2], `@semcore/illustration` [2.39.1 ~> 2.39.2], `@semcore/utils` [4.43.2 ~> 4.43.3], `@semcore/core` [2.36.1 ~> 2.36.2]).

## [4.40.1] - 2024-11-08

### Changed

- Version patch update due to children dependencies update (`@semcore/flex-box` [5.38.0 ~> 5.38.1], `@semcore/illustration` [2.39.0 ~> 2.39.1], `@semcore/utils` [4.43.0 ~> 4.43.2], `@semcore/core` [2.36.0 ~> 2.36.1]).

## [4.40.0] - 2024-11-01

### Changed

- Version minor update due to children dependencies update (`@semcore/flex-box` [5.37.0 ~> 5.38.0], `@semcore/illustration` [2.38.0 ~> 2.39.0], `@semcore/utils` [4.42.0 ~> 4.43.0], `@semcore/core` [2.35.0 ~> 2.36.0]).

## [4.39.0] - 2024-10-28

### Changed

- Version minor update due to children dependencies update (`@semcore/flex-box` [5.36.0 ~> 5.37.0], `@semcore/illustration` [2.37.0 ~> 2.38.0], `@semcore/utils` [4.41.0 ~> 4.42.0], `@semcore/core` [2.34.0 ~> 2.35.0]).

## [4.38.0] - 2024-10-18

### Changed

- Version minor update due to children dependencies update (`@semcore/flex-box` [5.35.0 ~> 5.36.0], `@semcore/illustration` [2.36.0 ~> 2.37.0], `@semcore/utils` [4.39.0 ~> 4.41.0], `@semcore/core` [2.33.0 ~> 2.34.0]).

## [4.37.0] - 2024-10-11

### Changed

- Version minor update due to children dependencies update (`@semcore/flex-box` [5.34.0 ~> 5.35.0], `@semcore/illustration` [2.35.0 ~> 2.36.0], `@semcore/utils` [4.38.0 ~> 4.39.0], `@semcore/core` [2.32.0 ~> 2.33.0]).

## [4.36.0] - 2024-10-04

### Changed

- Version minor update due to children dependencies update (`@semcore/flex-box` [5.33.1 ~> 5.34.0], `@semcore/illustration` [2.34.1 ~> 2.35.0], `@semcore/utils` [4.36.2 ~> 4.38.0], `@semcore/core` [2.31.1 ~> 2.32.0]).

## [4.35.1] - 2024-09-27

### Changed

- Version patch update due to children dependencies update (`@semcore/flex-box` [5.33.0 ~> 5.33.1], `@semcore/illustration` [2.34.0 ~> 2.34.1], `@semcore/utils` [4.36.0 ~> 4.36.2], `@semcore/core` [2.31.0 ~> 2.31.1]).

## [4.35.0] - 2024-09-20

### Changed

- Version minor update due to children dependencies update (`@semcore/flex-box` [5.32.0 ~> 5.33.0], `@semcore/illustration` [2.33.0 ~> 2.34.0], `@semcore/utils` [4.35.0 ~> 4.36.0], `@semcore/core` [2.30.0 ~> 2.31.0]).

## [4.34.0] - 2024-09-06

### Changed

- Version minor update due to children dependencies update (`@semcore/flex-box` [5.31.2 ~> 5.32.0], `@semcore/illustration` [2.32.0 ~> 2.33.0], `@semcore/utils` [4.32.2 ~> 4.35.0], `@semcore/core` [2.29.2 ~> 2.30.0]).

## [4.33.0] - 2024-08-12

### Changed

- Version minor update due to children dependencies update (`@semcore/illustration` [2.31.2 ~> 2.32.0]).

## [4.32.2] - 2024-08-05

### Changed

- Version patch update due to children dependencies update (`@semcore/flex-box` [5.31.1 ~> 5.31.2], `@semcore/illustration` [2.31.1 ~> 2.31.2], `@semcore/utils` [4.32.1 ~> 4.32.2], `@semcore/core` [2.29.1 ~> 2.29.2]).

## [4.32.1] - 2024-07-30

### Changed

- Version patch update due to children dependencies update (`@semcore/flex-box` [5.31.0 ~> 5.31.1], `@semcore/illustration` [2.31.0 ~> 2.31.1], `@semcore/utils` [4.32.0 ~> 4.32.1], `@semcore/core` [2.29.0 ~> 2.29.1]).

## [4.32.0] - 2024-07-26

### Changed

- Version minor update due to children dependencies update (`@semcore/flex-box` [5.30.0 ~> 5.31.0], `@semcore/illustration` [2.30.0 ~> 2.31.0], `@semcore/utils` [4.31.0 ~> 4.32.0], `@semcore/core` [2.28.0 ~> 2.29.0]).

## [4.31.0] - 2024-07-13

### Changed

- Version minor update due to children dependencies update (`@semcore/flex-box` [5.29.0 ~> 5.30.0], `@semcore/illustration` [2.29.0 ~> 2.30.0], `@semcore/utils` [4.30.0 ~> 4.31.0], `@semcore/core` [2.27.0 ~> 2.28.0]).

## [4.30.0] - 2024-06-26

### Changed

- Version minor update due to children dependencies update (`@semcore/flex-box` [5.28.0 ~> 5.29.0], `@semcore/illustration` [2.28.0 ~> 2.29.0], `@semcore/utils` [4.29.0 ~> 4.30.0], `@semcore/core` [2.26.0 ~> 2.27.0]).

## [4.29.0] - 2024-06-13

### Changed

- Version minor update due to children dependencies update (`@semcore/flex-box` [5.27.2 ~> 5.28.0], `@semcore/illustration` [2.27.2 ~> 2.28.0], `@semcore/utils` [4.28.2 ~> 4.29.0], `@semcore/core` [2.25.2 ~> 2.26.0]).

## [4.28.2] - 2024-06-12

### Changed

- Version patch update due to children dependencies update (`@semcore/flex-box` [5.27.1 ~> 5.27.2], `@semcore/illustration` [2.27.1 ~> 2.27.2], `@semcore/utils` [4.28.1 ~> 4.28.2], `@semcore/core` [2.25.1 ~> 2.25.2]).

## [4.28.1] - 2024-05-28

### Changed

- Version patch update due to children dependencies update (`@semcore/flex-box` [5.27.0 ~> 5.27.1], `@semcore/illustration` [2.27.0 ~> 2.27.1], `@semcore/utils` [4.28.0 ~> 4.28.1], `@semcore/core` [2.25.0 ~> 2.25.1]).

## [4.28.0] - 2024-05-23

### Changed

- Version minor update due to children dependencies update (`@semcore/flex-box` [5.26.0 ~> 5.27.0], `@semcore/illustration` [2.26.0 ~> 2.27.0], `@semcore/utils` [4.27.0 ~> 4.28.0], `@semcore/core` [2.24.0 ~> 2.25.0]).

## [4.27.0] - 2024-05-22

### Changed

- Version minor update due to children dependencies update (`@semcore/flex-box` [5.25.1 ~> 5.26.0], `@semcore/illustration` [2.25.1 ~> 2.26.0], `@semcore/utils` [4.26.2 ~> 4.27.0], `@semcore/core` [2.23.1 ~> 2.24.0]).

## [4.26.1] - 2024-05-17

### Changed

- Version patch update due to children dependencies update (`@semcore/flex-box` [5.25.0 ~> 5.25.1], `@semcore/illustration` [2.25.0 ~> 2.25.1], `@semcore/utils` [4.26.1 ~> 4.26.2], `@semcore/core` [2.23.0 ~> 2.23.1]).

## [4.26.0] - 2024-05-17

### Changed

- Version minor update due to children dependencies update (`@semcore/flex-box` [5.24.0 ~> 5.25.0], `@semcore/illustration` [2.24.0 ~> 2.25.0], `@semcore/utils` [4.25.0 ~> 4.26.1], `@semcore/core` [2.22.0 ~> 2.23.0]).
...
- Version patch update due to children dependencies update (`@semcore/flex-box` [5.22.1 ~> 5.22.2], `@semcore/illustration` [2.22.1 ~> 2.22.2], `@semcore/utils` [4.23.1 ~> 4.23.2], `@semcore/core` [2.20.1 ~> 2.20.2]).
...
- Version patch update due to children dependencies update (`@semcore/flex-box` [5.20.0 ~> 5.20.1], `@semcore/illustration` [2.19.0 ~> 2.20.0], `@semcore/utils` [4.21.0 ~> 4.21.1], `@semcore/core` [2.18.0 ~> 2.18.1]).
...
- Version prepatch update due to children dependencies update (`@semcore/flex-box` [5.7.2 ~> 5.7.3], `@semcore/illustration` [2.7.2 ~> 2.7.3], `@semcore/utils` [4.7.2 ~> 4.8.0], `@semcore/core` [2.7.2 ~> 2.7.3]).
...
- Version prepatch update due to children dependencies update (`@semcore/flex-box` [5.6.0 ~> 5.6.1], `@semcore/illustration` [2.6.0 ~> 2.6.1], `@semcore/utils` [4.6.0 ~> 4.6.1], `@semcore/core` [2.6.0 ~> 2.6.1]).
