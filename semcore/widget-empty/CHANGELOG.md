...
- Version patch update due to children dependencies update (`@semcore/flex-box` [5.25.1 ~> 5.25.2], `@semcore/illustration` [2.25.1 ~> 2.25.2], `@semcore/utils` [4.26.2 ~> 4.26.3], `@semcore/core` [2.23.1 ~> 2.23.2]).
