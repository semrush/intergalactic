...
- Version minor update due to children dependencies update (`@semcore/flex-box` [5.23.0 ~> 5.24.0], `@semcore/illustration` [2.23.0 ~> 2.24.0], `@semcore/utils` [4.24.0 ~> 4.25.0], `@semcore/core` [2.21.0 ~> 2.22.0]).
