...
- Version patch update due to children dependencies update (`@semcore/flex-box` [4.7.15 ~> 4.7.16], `@semcore/illustration` [1.4.10 ~> 1.4.11], `@semcore/utils` [3.48.1 ~> 3.49.0]).
