...
- Version patch update due to children dependencies update (`@semcore/animation` [1.10.6 ~> 1.10.7], `@semcore/flex-box` [4.7.20 ~> 4.7.21], `@semcore/icon` [3.14.8 ~> 3.14.9], `@semcore/utils` [3.50.4 ~> 3.50.5]).
