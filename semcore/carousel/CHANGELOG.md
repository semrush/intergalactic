...
- Version patch update due to children dependencies update (`@semcore/button` [16.0.10 ~> 16.0.11], `@semcore/breakpoints` [16.0.10 ~> 16.0.11], `@semcore/base-components` [16.4.0 ~> 16.4.1]).

## [16.1.10] - 2025-10-06

### Changed

- Version patch update due to children dependencies update (`@semcore/button` [16.0.9 ~> 16.0.10], `@semcore/breakpoints` [16.0.9 ~> 16.0.10], `@semcore/base-components` [16.2.3 ~> 16.4.0]).

## [16.1.9] - 2025-09-17

### Changed

- Version patch update due to children dependencies update (`@semcore/button` [16.0.8 ~> 16.0.9], `@semcore/breakpoints` [16.0.8 ~> 16.0.9], `@semcore/base-components` [16.2.2 ~> 16.2.3]).

## [16.1.8] - 2025-09-05

### Changed

- Version patch update due to children dependencies update (`@semcore/icon` [16.6.0 ~> 16.7.0], `@semcore/button` [16.0.7 ~> 16.0.8], `@semcore/breakpoints` [16.0.7 ~> 16.0.8], `@semcore/base-components` [16.2.1 ~> 16.2.2]).
...
- Version patch update due to children dependencies update (`@semcore/icon` [16.2.3 ~> 16.4.0], `@semcore/button` [16.0.4 ~> 16.0.5], `@semcore/breakpoints` [16.0.4 ~> 16.0.5], `@semcore/base-components` [16.1.1 ~> 16.1.2]).

## [16.1.4] - 2025-07-04

### Changed

- Version patch update due to children dependencies update (`@semcore/icon` [16.2.2 ~> 16.2.3], `@semcore/button` [16.0.3 ~> 16.0.4], `@semcore/modal` [16.1.3 ~> 16.1.4], `@semcore/breakpoints` [16.0.3 ~> 16.0.4], `@semcore/base-components` [16.1.0 ~> 16.1.1]).

## [16.1.3] - 2025-06-23

### Changed

- Version patch update due to children dependencies update (`@semcore/button` [16.0.2 ~> 16.0.3], `@semcore/breakpoints` [16.0.2 ~> 16.0.3], `@semcore/base-components` [16.0.2 ~> 16.1.0]).
...
- Version patch update due to children dependencies update (`@semcore/utils` [4.48.4 ~> 4.48.5], `@semcore/button` [5.43.2 ~> 5.43.3], `@semcore/breakpoints` [1.41.3 ~> 1.41.4]).

## [3.49.1] - 2025-05-09

### Changed

- Version patch update due to children dependencies update (`@semcore/icon` [4.61.0 ~> 4.62.0], `@semcore/utils` [4.48.2 ~> 4.48.4], `@semcore/button` [5.43.1 ~> 5.43.2], `@semcore/breakpoints` [1.41.2 ~> 1.41.3]).
...
- Version patch update due to children dependencies update (`@semcore/utils` [4.48.1 ~> 4.48.2], `@semcore/button` [5.43.0 ~> 5.43.1], `@semcore/breakpoints` [1.41.1 ~> 1.41.2]).
...
- Version patch update due to children dependencies update (`@semcore/utils` [4.26.1 ~> 4.26.2], `@semcore/button` [5.26.0 ~> 5.26.1], `@semcore/breakpoints` [1.25.0 ~> 1.25.1]).
...
- Version patch update due to children dependencies update (`@semcore/utils` [4.22.0 ~> 4.22.1], `@semcore/button` [5.22.0 ~> 5.22.1], `@semcore/breakpoints` [1.21.0 ~> 1.21.1]).
