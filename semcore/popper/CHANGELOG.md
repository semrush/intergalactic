...
* Invisible focus return and catch elements are removed that were used for keyboard users focus flow control. Instead,trigger may ignore focus event if happens just after corresponding popper close.
