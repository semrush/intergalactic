...
- Version patch update due to children dependencies update (`@semcore/animation` [1.9.4 ~> 1.9.5], `@semcore/flex-box` [4.7.12 ~> 4.7.13], `@semcore/neighbor-location` [3.1.18 ~> 3.1.19], `@semcore/outside-click` [2.5.17 ~> 2.5.18], `@semcore/utils` [3.47.3 ~> 3.47.4]).
