...
- Version patch update due to children dependencies update (`@semcore/flex-box` [4.6.1 ~> 4.6.2], `@semcore/neighbor-location` [3.1.1 ~> 3.1.2], `@semcore/outside-click` [2.5.1 ~> 2.5.2], `@semcore/utils` [3.39.0 ~> 3.39.1]).
