...
* By convention, all of our styled tags are capitalized `S + ComponentName`. We don’t need to write styles with the `.button` classes, just use the tag names `SButton`.
...
**We can use variables as properties:**
