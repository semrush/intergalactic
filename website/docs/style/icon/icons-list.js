const iconsList = {
  icons: [
    ...
    },
    {
      ...
      size: ['l', 'm'],
      group: 'Brand',
      tags: ['reddit', 'logo', 'icon', 'snoo mascot', 'social', 'media', 'forum', 'community', 'discussion', 'chat', 'alien', 'share', 'post', 'content'],
    },
    {
      name: 'Safari',
      size: ['l', 'm'],
    ...
    {
      name: 'GoogleGenerativeAIColored',
      size: ['l', 'm'],
      group: 'Color',
      tags: [
        'gemini',
