const iconsList = {
  icons: [
    ...
    },
    {
      ...
      size: ['l', 'm'],
      group: 'AI',
      tags: ['ai', 'искусственный', 'интеллект', 'ask', 'спросить', 'bing', 'бинг'],
    },
    {
      name: 'ChatAI',
      size: ['l', 'm'],
      group: 'AI',
      tags: ['ai', 'искусственный', 'интеллект', 'ask', 'спросить', 'chat', 'чат', 'bing', 'бинг'],
    },
    {
      name: 'StoriesAI',
      size: ['l', 'm'],
      group: 'AI',
      tags: ['ai', 'искусственный', 'интеллект', 'stories', 'истории', 'сториз', 'bing', 'бинг'],
    },
    {
      name: 'SummaryAI',
      size: ['l', 'm'],
      group: 'AI',
      tags: ['ai', 'искусственный', 'интеллект', 'summary', 'саммари', 'bing', 'бинг'],
    },
    {
      name: 'Ad',
      size: ['l', 'm'],
