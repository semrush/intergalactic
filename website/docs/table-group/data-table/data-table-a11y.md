...
| `DataTable.Head`                  | `aria-sort="none/ascending/descending"` | This attribute is set to a specific value when a column is sorted in ascending or descending order. When sorting isn't applied the default value is `none`.                                                                                                                                                                                                               |
