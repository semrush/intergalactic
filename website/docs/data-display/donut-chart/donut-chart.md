...
| **hover**   | ![donut with hover state](static/donut-hover-big.png)     | When hovering over a sector, the `outerRadius` increases by 8px.                                                                                                                                                                                                               |
|             | ![donut with hover state](static/donut-hover-small.png)   |                                                                                                                                                                                                                                                                                |
| **active**  | ![donut with active state](static/donut-active-big.png)   | The active sector of the circle shall be in the hover state (`outerRadius` increased by 8px).                                                                                                                                                                                  |
