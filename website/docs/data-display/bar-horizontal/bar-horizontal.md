...
We have a compact version of the horizontal bar chart — **[Compact horizontal bar chart](/data-display/bar-horizontal-compact/bar-horizontal-compact)**. Use it when values of all categories add up to 100%, and you need to save space in the interface, and the category names can be long (e.g., in localization).
