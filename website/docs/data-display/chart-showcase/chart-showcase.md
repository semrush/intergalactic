...
const group = {
  bar: {
    title: 'Bar chart',
    route: '../bar-chart/bar-chart',
    disabled: false,
    type: 'charts',
  },
  horizontalBar: {
    title: 'Horizontal bar chart',
    route: '../bar-horizontal/bar-horizontal',
    disabled: false,
    type: 'charts',
  },
  horizontalBarCompact: {
    title: 'Compact horizontal bar chart',
    route: '../bar-horizontal-compact/bar-horizontal-compact',
    disabled: false,
    type: 'charts',
  },
  histogram: {
  ...
  donut: {
    title: 'Donut chart',
    route: '../donut-chart/donut-chart',
    disabled: false,
    type: 'charts',
  },
  cigaretteChart: {
    title: 'Cigarette bar chart',
    route: '../cigarette-chart/cigarette-chart',
    disabled: false,
    type: 'charts',
  },
  bubble: {
...
const group = {
  ...
  barStacked: {
    ...
    route: '../stacked-bar-chart/stacked-bar-chart',
    disabled: false,
    type: 'charts',
  },
  horizontalBar: {
  ...
  stackedHorizontalBar: {
    ...
    route: '../stacked-horizontal-bar/stacked-horizontal-bar',
    disabled: false,
    type: 'charts',
  },
  histogram: {
  ...
  //   route: '../stacked-histogram/stacked-histogram',
  //   disabled: true,
  //   type: 'charts',
  // },
  line: {
    title: 'Line chart',
    route: '../line-chart/line-chart',
    disabled: false,
    type: 'charts',
  },
};
...
const group = {
  ...
  area: {
    title: 'Area chart',
    route: '../area-chart/area-chart',
    disabled: false,
    type: 'charts',
  },
  areaStacked: {
    title: 'Stacked area chart',
    route: '../stacked-area-chart/stacked-area-chart',
    disabled: false,
    type: 'charts',
  },
  bar: {
  ...
  miniTrend: {
    ...
    route: '../combined-chart/combined-chart',
    disabled: true,
    type: 'charts',
  },
  heatmap: {
...
const group = {
  ...
  funnel: {
    title: 'Funnel chart',
    route: '../funnel-chart/funnel-chart',
    disabled: true,
    type: 'charts',
  },
};
...
const group = {
  ...
  polar: {
    title: 'Polar chart',
    route: '../polar-chart/polar-chart',
    disabled: true,
    type: 'charts',
  },
  alluvial: {
    title: 'Alluvial chart',
    route: '../alluvial-chart/alluvial-chart',
    disabled: true,
    type: 'charts',
  },
  quadrant: {
    title: 'Quadrant chart',
    route: '../quadrant-chart/quadrant-chart',
    disabled: true,
    type: 'charts',
  },
};
...
const group = {
  choroplethMap: {
    ...
    route: '../choropleth-map/choropleth-map',
    disabled: true,
    type: 'charts',
  },
};
