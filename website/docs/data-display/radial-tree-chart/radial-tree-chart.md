...
| Hover   | ![](static/hover.png)     | For the text's hover state use the next color hue. e.g., `--blue-500`, `--red-500`, `--green-500` , etc. **Don’t change the color of the additional line and the circle bullet.**                                                                        |
