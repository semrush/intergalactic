...
For understanding the mathematics, used in `Change.Bubble` to calculate common scale, refer to [our GitHub repository](https://github.com/semrush/intergalactic/blob/master/semcore/d3-chart/src/component/Chart/BubbleChart.tsx#L84).
:::
