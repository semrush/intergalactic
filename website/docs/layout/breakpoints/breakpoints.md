...
::: tip
Most of the core components can be used on the smaller screens. We need to increase their size to the biggest (`L`) for ease of use on touch devices. We can find the examples in the [Example tab](/layout/breakpoints/breakpoints-code).
:::
