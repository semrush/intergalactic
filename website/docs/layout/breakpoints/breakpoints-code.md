...
<script lang="tsx">
  export Demo from 'stories/components/base-components/breakpoints/docs/examples/simple-use.tsx';
</script>
...
<script lang="tsx">
  export Demo from 'stories/components/base-components/breakpoints/docs/examples/manual-control.tsx';
</script>
...
<script lang="tsx">
  export Demo from 'stories/components/base-components/breakpoints/docs/examples/custom-media.tsx';
</script>
...
<script lang="tsx">
  export Demo from 'stories/components/base-components/breakpoints/docs/examples/mocking.tsx';
</script>
