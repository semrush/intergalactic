...
- We can set your own breakpoints, if it's necessary for the correct display of the interface in a particular case.
...
| **min-width: 768px** (768-1199) | 6       | 24px   | 720px                                                 | `margin: 24px 24px 96px` for landing pages, `margin: 16px 24px 96px` for product pages | ![](static/breakpoints-768-tablet.png)             | **Mobile & tablet devices**. We can arrange the content as a two-column structure. The left menu is hidden.              |
