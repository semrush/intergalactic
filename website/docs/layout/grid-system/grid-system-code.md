...
<script lang="tsx">
  export Demo from 'stories/components/base-components/grid/docs/examples/example-use.tsx';
</script>
...
<script lang="tsx">
  export Demo from 'stories/components/base-components/grid/docs/examples/change-in-general-offset.tsx';
</script>
...
<script lang="tsx">
  export Demo from 'stories/components/base-components/grid/docs/examples/change-in-the-general-gutter-between-the-columns.tsx';
</script>
...
<script lang="tsx">
  export Demo from 'stories/components/base-components/grid/docs/examples/automatic-column-size-detection.tsx';
</script>
...
<script lang="tsx">
  export Demo from 'stories/components/base-components/grid/docs/examples/responsive.tsx';
</script>
...
<script lang="tsx">
  export Demo from 'stories/components/base-components/grid/docs/examples/responsive-alternative-api.tsx';
</script>
