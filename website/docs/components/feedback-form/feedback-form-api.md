---
title: Feedback
tabs: Design('feedback-form'), A11y('feedback-form-a11y'), API('feedback-form-api'), Examples('feedback-form-code'), Changelog('feedback-form-changelog')
---
...
<TypesView type="NSFeedbackFormFeedbackRating.Props" :types={...types} />
