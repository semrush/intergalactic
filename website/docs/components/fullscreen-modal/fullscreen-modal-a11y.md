...
| `FullscreenModal`         | `aria-modal="true"`        | Tells assistive technologies that the content underneath the current dialog is not available for interaction. <br>Gets this attribute from [Modal](/components/modal/modal). |
