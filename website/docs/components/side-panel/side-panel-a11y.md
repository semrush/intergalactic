...
tabs: Design('side-panel'), A11y('side-panel-a11y'), API('side-panel-api'), Examples('side-panel-code'), Changelog('side-panel-changelog')
---
...
| `SidePanel`             | `aria-modal="true"`     | Tells assistive technologies that the content underneath the current dialog isn't available for interaction. |
