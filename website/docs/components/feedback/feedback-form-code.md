...
The information on the GDPR should be obligatorily shown to the users from Europe. Refer to the [component's guide](/components/feedback/feedback) for the styles and its content.
