...
| `aria-valuetext="string"`         | Allows to represent the progress values in a convenient format, e.g., announce absolute values beside percentages ([example](./progress-bar-code#basic-usage)). |
