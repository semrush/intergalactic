...
| --------------------------------- | ------- | -------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------- |
| `tabIndex="0"`                    | `div`   | Includes the ProgressBar in the page `Tab` sequence. While it's not a mandatory, but can help in enhancing ProgressBar discoverability by making it focusable. |
