...
- Write briefly and concisely. The information in FeaturePopover shouldn't exceed the minimum required to start using the function. Move additional step-by-step instructions to `Info` icons, hint links and so on.
