...
|                     | `aria-checked="true"`  | Identifies radio buttons which is checked.                                                                                                                                                                                                                                                                                                                                                            |
...
|                     | `aria-selected="true"`  | Indicates the tab control is activated and its associated panel is displayed. Set when a user activates a tab. Does not change when focus moves in the tablist.                                                                                                                                                                                                                           |
|                     | `aria-selected="false"` | Indicates the tab control is not active and its associated panel is not displayed. Set for all tab elements in the tab set except the active tab.                                                                                                                                                                                                                                         |
