...
::: tip
Note: These plugins affect only Intergalactic components translations and can't be used for localization of your application.
:::

To use it, install `@semcore/i18n-unplugin`.
