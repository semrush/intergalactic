...
<script lang="tsx">
  export Demo from 'stories/components/base-components/popper/docs/examples/show-hide.tsx';
</script>
...
<script lang="tsx">
  export Demo from 'stories/components/base-components/popper/docs/examples/events-trigger.tsx';
</script>
...
<script lang="tsx">
  export Demo from 'stories/components/base-components/popper/docs/examples/click-outside.tsx';
</script>
...
<script lang="tsx">
  export Demo from 'stories/components/base-components/popper/docs/examples/placement.tsx';
</script>
...
<script lang="tsx">
  export Demo from 'stories/components/base-components/popper/docs/examples/custom-tag.tsx';
</script>
...
**For example**, `getPopperProps()` will return style and ref, if we do `<input {...getPopperProps()} ref={myRef}/>`, this won't work since we will overwrite `ref`. And if we pass `ref` inside the function, `<input {... getPopperProps ({ref: myRef})} />`, then we call two functions one after another, and everything will function.
...
<script lang="tsx">
  export Demo from 'stories/components/base-components/popper/docs/examples/render-functions.tsx';
</script>
...
<script lang="tsx">
  export Demo from 'stories/components/base-components/popper/docs/examples/disabled-portal.tsx';
</script>
