...
<script lang="tsx">
  export Demo from 'stories/components/popper/docs/examples/show-hide.tsx';
</script>
...
<script lang="tsx">
  export Demo from 'stories/components/popper/docs/examples/events-trigger.tsx';
</script>
...
<script lang="tsx">
  export Demo from 'stories/components/popper/docs/examples/click-outside.tsx';
</script>
...
<script lang="tsx">
  export Demo from 'stories/components/popper/docs/examples/placement.tsx';
</script>
...
<script lang="tsx">
  export Demo from 'stories/components/popper/docs/examples/custom-tag.tsx';
</script>
...
<script lang="tsx">
  export Demo from 'stories/components/popper/docs/examples/render-functions.tsx';
</script>
...
<script lang="tsx">
  export Demo from 'stories/components/popper/docs/examples/disabled-portal.tsx';
</script>
