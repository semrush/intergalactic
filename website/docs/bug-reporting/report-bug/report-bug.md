...
- Note that Slack channel is not very helpful in terms of saving history, so important discussions or decisions should be documented elsewhere for reference.
