...
export default defineConfig({
  ...
  themeConfig: {
    ...
    footer: {
      ...
      copyright:
        '<a href="https://business.adobe.com/" target="_blank"><img class="footer-logo-img" src="/intergalactic/adobe-logo.svg" alt="Adobe" /></a>© 2026 Semrush Holdings. All rights reserved.',
    },
    siteTitle: false,
    notFound: {
      quote:
