...
- An interface designed with accessibility in mind is an interface that everyone can use equally. As technologies evolve and develop, they're used by more and more people all over the world.
...
- **Visual impairment:** users with this disability may find it challenging to read text that's too small or not displayed with high contrast, or to interpret complex graphics and diagrams that aren't designed with accessibility in mind.
...
- **[WebAIM](https://webaim.org/)** or Web Accessibility in Mind is a non-profit organization from the University of Utah, USA. It's actively involved in the development of standards, techniques and approaches for improving accessibility, and also provides accessibility consulting and training for the web community.
