...
| `Enter` | **When the menu is closed:** opens the menu. <br>**When the menu is open:** If an option has been highlighted, applies its value to the input and closes the menu.  |
