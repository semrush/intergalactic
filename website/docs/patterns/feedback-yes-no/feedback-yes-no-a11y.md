...
FeedbackYesNo form pattern consists of several components that have their own accessibility requirements. We can find more about each of them in their guides:
