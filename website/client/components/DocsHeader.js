...
import LinkExternalXS from '@semcore/icon/lib/LinkExternal/m';
import FigmaS from '@semcore/icon/lib/color/Figma/m';
import GitHubS from '@semcore/icon/lib/color/GitHub/m';
import EditS from '@semcore/icon/lib/Edit/m';
